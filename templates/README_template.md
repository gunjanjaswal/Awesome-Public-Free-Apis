...
<!-- API CATEGORIES LIST WILL BE INSERTED HERE -->

<!-- API CATEGORIES CONTENT WILL BE INSERTED HERE -->
...
| --- | --- | --- | --- |
<!-- TRENDING API REPOSITORIES WILL BE INSERTED HERE -->
...
| Repository | Description | Stars | Language |
| --- | --- | --- | --- |
<!-- TRENDING REPOSITORIES WILL BE INSERTED HERE -->
