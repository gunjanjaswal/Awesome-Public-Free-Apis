...
def save_api_data_to_json(data: Dict[str, Any], output_file: str = "api_data.json") -> None:
    """Save API data to a JSON file for use by other scripts."""
    try:
        with open(output_file, "w", encoding="utf-8") as f:
            json.dump(data, f, indent=2)
        print(f"Saved API data to {output_file}")
    except Exception as e:
...
def main() -> None:
    ...
    # Save API data to JSON file for use by other scripts
    save_api_data_to_json(updated_data)
