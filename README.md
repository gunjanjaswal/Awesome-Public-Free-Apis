...
| [Domainsdb.info](https://domainsdb.info/) | Registered Domain Names Search | none | Yes | no |
...
| [markerapi](https://markerapi.com) | Trademark Search | none | No | unknown |
...
| [Tenders in Hungary](https://tenders.guru/hu/api) | Get data for procurements in Hungary in JSON format | none | Yes | unknown |
| [Tenders in Poland](https://tenders.guru/pl/api) | Get data for procurements in Poland in JSON format | none | Yes | unknown |
| [Tenders in Romania](https://tenders.guru/ro/api) | Get data for procurements in Romania in JSON format | none | Yes | unknown |
| [Tenders in Spain](https://tenders.guru/es/api) | Get data for procurements in Spain in JSON format | none | Yes | unknown |
| [Tenders in Ukraine](https://tenders.guru/ua/api) | Get data for procurements in Ukraine in JSON format | none | Yes | unknown |
...
| [Church Calendar](http://calapi.inadiutorium.cz/) | Catholic liturgical calendar | none | No | unknown |
| [Czech Namedays Calendar](https://svatky.adresa.info) | Lookup for a name and returns nameday date | none | No | unknown |
...
| [Hebrew Calendar](https://www.hebcal.com/home/developer-apis) | Convert between Gregorian and Hebrew, fetch Shabbat and Holiday times, etc | none | No | unknown |
| [Holidays](https://holidayapi.com/) | Historical data regarding holidays | `apiKey` | Yes | unknown |
| [LectServe](http://www.lectserve.com) | Protestant liturgical calendar | none | No | unknown |
| [Nager.Date](https://date.nager.at) | Public holidays for more than 90 countries | none | Yes | no |
| [Namedays Calendar](https://nameday.abalin.net) | Provides namedays for multiple countries | none | Yes | yes |
| [Non-Working Days](https://github.com/gadael/icsdb) | Database of ICS files for non working days | none | Yes | unknown |
| [Russian Calendar](https://github.com/egno/work-calendar) | Check if a date is a Russian holiday or not | none | Yes | no |
| [UK Bank Holidays](https://www.gov.uk/bank-holidays.json) | Bank holidays in England and Wales, Scotland and Northern Ireland | none | Yes | unknown |
...
| API | Description | Auth | HTTPS | CORS |
| --- | --- | --- | --- | --- |
| [AnonFiles](https://anonfiles.com/docs/api) | Upload and share your files anonymously | none | Yes | unknown |
| [BayFiles](https://bayfiles.com/docs/api) | Upload and share your files | none | Yes | unknown |
| [Box](https://developer.box.com/) | File Sharing and Storage | `OAuth` | Yes | unknown |
| [ddownload](https://ddownload.com/api) | File Sharing and Storage | `apiKey` | Yes | unknown |
| [Dropbox](https://www.dropbox.com/developers) | File Sharing and Storage | `OAuth` | Yes | unknown |
| [File.io](https://www.file.io) | Super simple file sharing, convenient, anonymous and secure | none | Yes | unknown |
...
| [Pantry](https://getpantry.cloud/) | Free JSON storage for small projects | none | Yes | yes |
...
| [The Null Pointer](https://0x0.st) | No-bullshit file hosting and URL shortening service | none | Yes | unknown |
...
| API | Description | Auth | HTTPS | CORS |
| --- | --- | --- | --- | --- |
| [0x](https://0x.org/api) | API for querying token and pool stats across various liquidity pools | none | Yes | yes |
| [1inch](https://1inch.io/api/) | API for querying decentralize exchange | none | Yes | unknown |
...
| [Bitcambio](https://nova.bitcambio.com.br/api/v3/docs#a-public) | Get the list of all traded assets in the exchange | none | Yes | unknown |
| [BitcoinAverage](https://apiv2.bitcoinaverage.com/) | Digital Asset Price Data for the blockchain industry | `apiKey` | Yes | unknown |
| [BitcoinCharts](https://bitcoincharts.com/about/exchanges/) | Financial and Technical Data related to the Bitcoin Network | none | Yes | unknown |
...
| [CoinCap](https://docs.coincap.io/) | Real time Cryptocurrency prices through a RESTful API | none | Yes | unknown |
| [CoinDCX](https://docs.coindcx.com/) | Cryptocurrency Trading Platform | `apiKey` | Yes | unknown |
| [CoinDesk](https://old.coindesk.com/coindesk-api/) | CoinDesk's Bitcoin Price Index (BPI) in multiple currencies | none | Yes | unknown |
| [CoinGecko](http://www.coingecko.com/api) | Cryptocurrency Price, Market, and Developer/Social Data | none | Yes | yes |
| [Coinigy](https://coinigy.docs.apiary.io) | Interacting with Coinigy Accounts and Exchange Directly | `apiKey` | Yes | unknown |
| [Coinlib](https://coinlib.io/apidocs) | Crypto Currency Prices | `apiKey` | Yes | unknown |
| [Coinlore](https://www.coinlore.com/cryptocurrency-data-api) | Cryptocurrencies prices, volume and more | none | Yes | unknown |
| [CoinMarketCap](https://coinmarketcap.com/api/) | Cryptocurrencies Prices | `apiKey` | Yes | unknown |
| [Coinpaprika](https://api.coinpaprika.com) | Cryptocurrencies prices, volume and more | none | Yes | yes |
...
| [CoinStats](https://documenter.getpostman.com/view/5734027/RzZ6Hzr3?version=latest) | Crypto Tracker | none | Yes | unknown |
| [CryptAPI](https://docs.cryptapi.io/) | Cryptocurrency Payment Processor | none | Yes | unknown |
| [CryptingUp](https://www.cryptingup.com/apidoc/#introduction) | Cryptocurrency data | none | Yes | unknown |
| [CryptoCompare](https://www.cryptocompare.com/api#) | Cryptocurrencies Comparison | none | Yes | unknown |
| [CryptoMarket](https://api.exchange.cryptomkt.com/) | Cryptocurrencies Trading platform | `apiKey` | Yes | yes |
| [Cryptonator](https://www.cryptonator.com/api/) | Cryptocurrencies Exchange Rates | none | Yes | unknown |
...
| [Gemini](https://docs.gemini.com/rest-api/) | Cryptocurrencies Exchange | none | Yes | unknown |
...
| [Localbitcoins](https://localbitcoins.com/api-docs/) | P2P platform to buy and sell Bitcoins | none | Yes | unknown |
| [Mempool](https://mempool.space/api) | Bitcoin API Service focusing on the transaction fee | none | Yes | no |
| [MercadoBitcoin](https://www.mercadobitcoin.com.br/api-doc/) | Brazilian Cryptocurrency Information | none | Yes | unknown |
| [Messari](https://messari.io/api) | Provides API endpoints for thousands of crypto assets | none | Yes | unknown |
| [Nexchange](https://nexchange2.docs.apiary.io/) | Automated cryptocurrency exchange service | none | No | yes |
...
| [Solana JSON RPC](https://docs.solana.com/developing/clients/jsonrpc-api) | Provides various endpoints to interact with the Solana Blockchain | none | Yes | unknown |
| [Technical Analysis](https://technical-analysis-api.com) | Cryptocurrency prices and technical analysis | `apiKey` | Yes | no |
| [VALR](https://docs.valr.com/) | Cryptocurrency Exchange based in South Africa | `apiKey` | Yes | unknown |
| [WorldCoinIndex](https://www.worldcoinindex.com/apiservice) | Cryptocurrencies Prices | `apiKey` | Yes | unknown |
| [ZMOK](https://zmok.io) | Ethereum JSON RPC API and Web3 provider | none | Yes | unknown |
...
| [Bank of Russia](https://www.cbr.ru/development/SXML/) | Exchange rates and currency conversion | none | Yes | unknown |
| [Currency-api](https://github.com/fawazahmed0/currency-api#readme) | Free Currency Exchange Rates API with 150+ Currencies & No Rate Limits | none | Yes | yes |
...
| [Czech National Bank](https://www.cnb.cz/cs/financni_trhy/devizovy_trh/kurzy_devizoveho_trhu/denni_kurz.xml) | A collection of exchange rates | none | Yes | unknown |
| [Economia.Awesome](https://docs.awesomeapi.com.br/api-de-moedas) | Portuguese free currency prices and conversion with no rate limits | none | Yes | unknown |
| [ExchangeRate-API](https://www.exchangerate-api.com) | Free currency conversion | `apiKey` | Yes | yes |
| [Exchangerate.host](https://exchangerate.host) | Free foreign exchange & crypto rates API | none | Yes | unknown |
| [Exchangeratesapi.io](https://exchangeratesapi.io) | Exchange rates with currency conversion | `apiKey` | Yes | yes |
| [Frankfurter](https://www.frankfurter.app/docs) | Exchange rates, currency conversion and time series | none | Yes | yes |
| [FreeForexAPI](https://freeforexapi.com/Home/Api) | Real-time foreign exchange rates for major currency pairs | none | Yes | no |
| [National Bank of Poland](http://api.nbp.pl/en.html) | A collection of currency exchange rates (data in XML and JSON) | none | Yes | yes |
| [VATComply.com](https://www.vatcomply.com/documentation) | Exchange rates, geolocation and VAT number validation | none | Yes | yes |
...
| [Postman Echo](https://www.postman-echo.com) | Test api server to receive and return value from HTTP method | none | Yes | unknown |
| [PurgoMalum](http://www.purgomalum.com) | Content validator against profanity & obscenity | none | No | unknown |
...
| [Axolotl](https://theaxolotlapi.netlify.app/) | Collection of axolotl pictures and facts | none | Yes | no |
| [Cat Facts](https://alexwohlbruck.github.io/cat-facts/) | Daily cat facts | none | Yes | no |
| [Cataas](https://cataas.com/) | Cat as a service (cats pictures and gifs) | none | Yes | no |
| [Cats](https://docs.thecatapi.com/) | Pictures of cats from Tumblr | `apiKey` | Yes | no |
| [Dog Facts](https://dukengn.github.io/Dog-facts-API/) | Random dog facts | none | Yes | yes |
| [Dogs](https://dog.ceo/dog-api/) | Based on the Stanford Dogs Dataset | none | Yes | yes |
| [eBird](https://documenter.getpostman.com/view/664302/S1ENwy59) | Retrieve recent or notable birding observations within a region | `apiKey` | Yes | no |
| [FishWatch](https://www.fishwatch.gov/developers) | Information and pictures about individual fish species | none | Yes | yes |
| [HTTP Cat](https://http.cat/) | Cat for every HTTP Status | none | Yes | yes |
| [HTTP Dog](https://http.dog/) | Dogs for every HTTP response status code | none | Yes | yes |
| [IUCN](http://apiv3.iucnredlist.org/api/v3/docs) | IUCN Red List of Threatened Species | `apiKey` | No | no |
| [MeowFacts](https://github.com/wh-iterabb-it/meowfacts) | Get random cat facts | none | Yes | no |
| [Movebank](https://github.com/movebank/movebank-api-doc) | Movement and Migration data of animals | none | Yes | yes |
| [Petfinder](https://www.petfinder.com/developers/) | Petfinder is dedicated to helping pets find homes, another resource to get pets adopted | `apiKey` | Yes | yes |
| [PlaceBear](https://placebear.com/) | Placeholder bear pictures | none | Yes | yes |
| [PlaceDog](https://place.dog) | Placeholder Dog pictures | none | Yes | yes |
| [PlaceKitten](https://placekitten.com/) | Placeholder Kitten pictures | none | Yes | yes |
| [RandomDog](https://random.dog/woof.json) | Random pictures of dogs | none | Yes | yes |
| [RandomDuck](https://random-d.uk/api) | Random pictures of ducks | none | Yes | no |
| [RandomFox](https://randomfox.ca/floof/) | Random pictures of foxes | none | Yes | no |
| [RescueGroups](https://userguide.rescuegroups.org/display/APIDG/API+Developers+Guide+Home) | Adoption | none | Yes | unknown |
| [Shibe.Online](http://shibe.online/) | Random pictures of Shiba Inu, cats or birds | none | Yes | yes |
| [The Dog](https://thedogapi.com/) | A public service all about Dogs, free to use when making your fancy new App, Website or Service | `apiKey` | Yes | no |
| [xeno-canto](https://xeno-canto.org/explore/api) | Bird recordings | none | Yes | unknown |
| [Zoo Animals](https://zoo-animal-api.herokuapp.com/) | Facts and pictures of zoo animals | none | Yes | yes |
| [AniAPI](https://aniapi.com/docs/) | Anime discovery, streaming & syncing with trackers | `OAuth` | Yes | yes |
| [AniDB](https://wiki.anidb.net/HTTP_API_Definition) | Anime Database | `apiKey` | No | unknown |
| [AniList](https://github.com/AniList/ApiV2-GraphQL-Docs) | Anime discovery & tracking | `OAuth` | Yes | unknown |
| [AnimeChan](https://github.com/RocktimSaikia/anime-chan) | Anime quotes (over 10k+) | none | Yes | no |
| [AnimeFacts](https://chandan-02.github.io/anime-facts-rest-api/) | Anime Facts (over 100+) | none | Yes | yes |
| [AnimeNewsNetwork](https://www.animenewsnetwork.com/encyclopedia/api.php) | Anime industry news | none | Yes | yes |
| [Catboy](https://catboys.com/api) | Neko images, funny GIFs & more | none | Yes | yes |
| [Danbooru Anime](https://danbooru.donmai.us/wiki_pages/help:api) | Thousands of anime artist database to find good anime art | `apiKey` | Yes | yes |
| [Jikan](https://jikan.moe) | Unofficial MyAnimeList API | none | Yes | yes |
| [Kitsu](https://kitsu.docs.apiary.io/) | Anime discovery platform | `OAuth` | Yes | yes |
| [MangaDex](https://api.mangadex.org/docs.html) | Manga Database and Community | `apiKey` | Yes | unknown |
| [Mangapi](https://rapidapi.com/pierre.carcellermeunier/api/mangapi3/) | Translate manga pages from one language to another | `apiKey` | Yes | unknown |
| [MyAnimeList](https://myanimelist.net/clubs.php?cid=13727) | Anime and Manga Database and Community | `OAuth` | Yes | unknown |
| [NekosBest](https://docs.nekos.best) | Neko Images & Anime roleplaying GIFs | none | Yes | yes |
| [Shikimori](https://shikimori.one/api/doc) | Anime discovery, tracking, forum, rates | `OAuth` | Yes | unknown |
| [Studio Ghibli](https://ghibliapi.herokuapp.com) | Resources from Studio Ghibli films | none | Yes | yes |
| [Trace Moe](https://soruly.github.io/trace.moe-api/#/) | A useful tool to get the exact scene of an anime from a screenshot | none | Yes | no |
| [Waifu.im](https://waifu.im/docs) | Get waifu pictures from an archive of over 4000 images and multiple tags | none | Yes | yes |
| [Waifu.pics](https://waifu.pics/docs) | Image sharing platform for anime images | none | Yes | no |
...
| [URLhaus](https://urlhaus-api.abuse.ch/) | Bulk queries and Download Malware Samples | none | Yes | yes |
...
| [Art Institute of Chicago](https://api.artic.edu/docs/) | Art | none | Yes | yes |
| [Colormind](http://colormind.io/api-access/) | Color scheme generator | none | No | unknown |
| [ColourLovers](http://www.colourlovers.com/api) | Get various patterns, palettes and images | none | No | unknown |
| [Cooper Hewitt](https://collection.cooperhewitt.org/api) | Smithsonian Design Museum | `apiKey` | Yes | unknown |
| [Dribbble](https://developer.dribbble.com) | Discover the world’s top designers & creatives | `OAuth` | Yes | unknown |
| [EmojiHub](https://github.com/cheatsnake/emojihub) | Get emojis by categories and groups | none | Yes | yes |
| [Europeana](https://pro.europeana.eu/resources/apis/search) | European Museum and Galleries content | `apiKey` | Yes | unknown |
| [Harvard Art Museums](https://github.com/harvardartmuseums/api-docs) | Art | `apiKey` | No | unknown |
| [Icon Horse](https://icon.horse) | Favicons for any website, with fallbacks | none | Yes | yes |
| [Iconfinder](https://developer.iconfinder.com) | Icons | `apiKey` | Yes | unknown |
| [Icons8](https://img.icons8.com/) | Icons (find "search icon" hyperlink in page) | none | Yes | unknown |
| [Lordicon](https://lordicon.com/) | Icons with predone Animations | none | Yes | yes |
| [Metropolitan Museum of Art](https://metmuseum.github.io/) | Met Museum of Art | none | Yes | no |
| [Noun Project](http://api.thenounproject.com/index.html) | Icons | `OAuth` | No | unknown |
| [PHP-Noise](https://php-noise.com/) | Noise Background Image Generator | none | Yes | yes |
| [Pixel Encounter](https://pixelencounter.com/api) | SVG Icon Generator | none | Yes | no |
| [Rijksmuseum](https://data.rijksmuseum.nl/object-metadata/api/) | RijksMuseum Data | `apiKey` | Yes | unknown |
| [Word Cloud](https://wordcloudapi.com/) | Easily create word clouds | `apiKey` | Yes | unknown |
| [xColors](https://x-colors.herokuapp.com/) | Generate & convert colors | none | Yes | yes |
...
| [Bhagavad Gita telugu](https://gita-api.vercel.app) | Bhagavad Gita API in telugu and odia languages | none | Yes | yes |
| [Bible-api](https://bible-api.com/) | Free Bible API with multiple languages | none | Yes | yes |
| [British National Bibliography](http://bnb.data.bl.uk/) | Books | none | No | unknown |
| [Crossref Metadata Search](https://github.com/CrossRef/rest-api-doc) | Books & Articles Metadata | none | Yes | unknown |
| [Ganjoor](https://api.ganjoor.net) | Classic Persian poetry works including access to related manuscripts, recitations and music tracks | `OAuth` | Yes | yes |
| [Google Books](https://developers.google.com/books/) | Books | `OAuth` | Yes | unknown |
| [GurbaniNow](https://github.com/GurbaniNow/api) | Fast and Accurate Gurbani RESTful API | none | Yes | unknown |
| [Gutendex](https://gutendex.com/) | Web-API for fetching data from Project Gutenberg Books Library | none | Yes | unknown |
| [Open Library](https://openlibrary.org/developers/api) | Books, book covers and related data | none | Yes | no |
| [Penguin Publishing](http://www.penguinrandomhouse.biz/webservices/rest/) | Books, book covers and related data | none | Yes | yes |
| [PoetryDB](https://github.com/thundercomb/poetrydb#readme) | Enables you to get instant data from our vast poetry collection | none | Yes | yes |
| [Quran](https://quran.api-docs.io/) | RESTful Quran API with multiple languages | none | Yes | yes |
| [Quran Cloud](https://alquran.cloud/api) | A RESTful Quran API to retrieve an Ayah, Surah, Juz or the entire Holy Quran | none | Yes | yes |
| [Quran-api](https://github.com/fawazahmed0/quran-api#readme) | Free Quran API Service with 90+ different languages and 400+ translations | none | Yes | yes |
| [Rig Veda](https://aninditabasu.github.io/indica/html/rv.html) | Gods and poets, their categories, and the verse meters, with the mandal and sukta number | none | Yes | unknown |
| [The Bible](https://docs.api.bible) | Everything you need from the Bible in one discoverable place | `apiKey` | Yes | unknown |
| [Thirukkural](https://api-thirukkural.web.app/) | 1330 Thirukkural poems and explanation in Tamil and English | none | Yes | yes |
| [Vedic Society](https://aninditabasu.github.io/indica/html/vs.html) | Descriptions of all nouns (names, places, animals, things) from vedic literature | none | Yes | unknown |
| [Wizard World](https://wizard-world-api.herokuapp.com/swagger/index.html) | Get information from the Harry Potter universe | none | Yes | yes |
| [Wolne Lektury](https://wolnelektury.pl/api/) | API for obtaining information about e-books available on the WolneLektury.pl website | none | Yes | unknown |
...
| [24 Pull Requests](https://24pullrequests.com/api) | Project to promote open source collaboration during December | none | Yes | yes |
...
| [Agify.io](https://agify.io) | Estimates the age from a first name | none | Yes | yes |
| [API Grátis](https://apigratis.com.br/) | Multiples services and public APIs | none | Yes | unknown |
| [ApicAgent](https://www.apicagent.com) | Extract device details from user-agent string | none | Yes | yes |
| [ApiFlash](https://apiflash.com/) | Chrome based screenshot API for developers | `apiKey` | Yes | unknown |
| [apilayer userstack](https://userstack.com/) | Secure User-Agent String Lookup JSON API | `OAuth` | Yes | unknown |
| [APIs.guru](https://apis.guru/api-doc/) | Wikipedia for Web APIs, OpenAPI/Swagger specs for public APIs | none | Yes | unknown |
...
| [Beeceptor](https://beeceptor.com/) | Build a mock Rest API endpoint in seconds | none | Yes | yes |
...
| [Bored](https://www.boredapi.com/) | Find random activities to fight boredom | none | Yes | unknown |
...
| [CDNJS](https://api.cdnjs.com/libraries/jquery) | Library info on CDNJS | none | Yes | unknown |
| [Changelogs.md](https://changelogs.md) | Structured changelog metadata from open source projects | none | Yes | unknown |
| [Ciprand](https://github.com/polarspetroll/ciprand) | Secure random string generator | none | Yes | no |
| [Cloudflare Trace](https://github.com/fawazahmed0/cloudflare-trace-api) | Get IP Address, Timestamp, User Agent, Country Code, IATA, HTTP Version, TLS/SSL Version & More | none | Yes | yes |
| [Codex](https://github.com/Jaagrav/CodeX) | Online Compiler for Various Languages | none | Yes | unknown |
...
| [CORS Proxy](https://github.com/burhanuday/cors-proxy) | Get around the dreaded CORS error by using this proxy as a middle man | none | Yes | yes |
| [CountAPI](https://countapi.xyz) | Free and simple counting service. You can use it to track page hits and specific events | none | Yes | yes |
...
| [DigitalOcean Status](https://status.digitalocean.com/api) | Status of all DigitalOcean services | none | Yes | unknown |
| [Docker Hub](https://docs.docker.com/docker-hub/api/latest/) | Interact with Docker Hub | `apiKey` | Yes | yes |
| [DomainDb Info](https://api.domainsdb.info/) | Domain name search to find all domains containing particular words/phrases/etc | none | Yes | unknown |
| [ExtendsClass JSON Storage](https://extendsclass.com/json-storage.html) | A simple JSON store API | none | Yes | yes |
...
| [Genderize.io](https://genderize.io) | Estimates a gender from a first name | none | Yes | yes |
...
| [host-t.com](https://host-t.com) | Basic DNS query via HTTP GET request | none | Yes | no |
| [Host.io](https://host.io) | Domains Data API for Developers | `apiKey` | Yes | yes |
| [HTTP2.Pro](https://http2.pro/doc/api) | Test endpoints for client and server HTTP/2 protocol support | none | Yes | unknown |
| [Httpbin](https://httpbin.org/) | A Simple HTTP Request & Response Service | none | Yes | yes |
| [Httpbin Cloudflare](https://cloudflare-quic.com/b/) | A Simple HTTP Request & Response Service with HTTP/3 Support by Cloudflare | none | Yes | yes |
...
| [Icanhazepoch](https://icanhazepoch.com) | Get Epoch time | none | Yes | yes |
| [Icanhazip](https://major.io/icanhazip-com-faq/) | IP Address API | none | Yes | yes |
| [IFTTT](https://platform.ifttt.com/docs/connect_api) | IFTTT Connect API | none | Yes | unknown |
| [Image-Charts](https://documentation.image-charts.com/) | Generate charts, QR codes and graph images | none | Yes | yes |
| [import.io](http://api.docs.import.io/) | Retrieve structured data from a website or RSS feed | `apiKey` | Yes | unknown |
| [ip-fast.com](https://ip-fast.com/docs/) | IP address, country and city | none | Yes | yes |
...
| [IPify](https://www.ipify.org/) | A simple IP Address API | none | Yes | unknown |
| [IPinfo](https://ipinfo.io/developers) | Another simple IP Address API | none | Yes | unknown |
| [jsDelivr](https://github.com/jsdelivr/data.jsdelivr.com) | Package info and download stats on jsDelivr CDN | none | Yes | yes |
| [JSON 2 JSONP](https://json2jsonp.com/) | Convert JSON to JSONP (on-the-fly) for easy cross-domain data requests using client-side JavaScript | none | Yes | unknown |
| [JSONbin.io](https://jsonbin.io) | Free JSON storage service. Ideal for small scale Web apps, Websites and Mobile apps | `apiKey` | Yes | yes |
| [Kroki](https://kroki.io) | Creates diagrams from textual descriptions | none | Yes | yes |
| [License-API](https://github.com/cmccandless/license-api/blob/master/README.md) | Unofficial REST API for choosealicense.com | none | Yes | no |
| [Logs.to](https://logs.to/) | Generate logs | `apiKey` | Yes | unknown |
| [Lua Decompiler](https://lua-decompiler.ferib.dev/) | Online Lua 5.1 Decompiler | none | Yes | yes |
| [MAC address vendor lookup](https://macaddress.io/api) | Retrieve vendor details and other information regarding a given MAC address or an OUI | `apiKey` | Yes | yes |
| [Micro DB](https://m3o.com/db) | Simple database service | `apiKey` | Yes | unknown |
| [MicroENV](https://microenv.com/) | Fake Rest API for developers | none | Yes | unknown |
| [Mocky](https://designer.mocky.io/) | Mock user defined test JSON for REST API endpoints | none | Yes | yes |
| [MY IP](https://www.myip.com/api-docs/) | Get IP address information | none | Yes | unknown |
| [Nationalize.io](https://nationalize.io) | Estimate the nationality of a first name | none | Yes | yes |
| [Netlify](https://docs.netlify.com/api/get-started/) | Netlify is a hosting service for the programmable web | `OAuth` | Yes | unknown |
| [NetworkCalc](https://networkcalc.com/api/docs) | Network calculators, including subnets, DNS, binary, and security tools | none | Yes | yes |
| [npm Registry](https://github.com/npm/registry/blob/master/docs/REGISTRY-API.md) | Query information about your favorite Node.js libraries programatically | none | Yes | unknown |
...
| [oyyi](https://oyyi.xyz/docs/1.0) | API for Fake Data, image/video conversion, optimization, pdf optimization and thumbnail generation | none | Yes | yes |
...
| [QR code](https://www.qrtag.net/api/) | Create an easy to read QR code and URL shortener | none | Yes | yes |
| [Qrcode Monkey](https://www.qrcode-monkey.com/qr-code-api-with-logo/) | Integrate custom and unique looking QR codes into your system or workflow | none | Yes | unknown |
| [QuickChart](https://quickchart.io/) | Generate chart and graph images | none | Yes | yes |
...
| [ReqRes](https://reqres.in/) | A hosted REST-API ready to respond to your AJAX requests | none | Yes | unknown |
| [RSS feed to JSON](https://rss-to-json-serverless-api.vercel.app) | Returns RSS feed in JSON format using feed URL | none | Yes | yes |
...
| [Serialif Color](https://color.serialif.com/) | Color conversion, complementary, grayscale and contrasted text | none | Yes | no |
...
| [SHOUTCLOUD](http://shoutcloud.io/) | ALL-CAPS AS A SERVICE | none | No | unknown |
| [Sonar](https://github.com/Cgboal/SonarSearch) | Project Sonar DNS Enumeration API | none | Yes | yes |
...
| [Statically](https://statically.io/) | A free CDN for developers | none | Yes | yes |
...
| [Wandbox](https://github.com/melpon/wandbox/blob/master/kennel2/API.rst) | Code compiler supporting 35+ languages mentioned at wandbox.org | none | Yes | unknown |
...
| [Chinese Character Web](http://ccdb.hemiola.com/) | Chinese character definitions and pronunciations | none | No | no |
| [Chinese Text Project](https://ctext.org/tools/api) | Online open-access digital library for pre-modern Chinese texts | none | Yes | unknown |
...
| [Free Dictionary](https://dictionaryapi.dev/) | Definitions, phonetics, pronounciations, parts of speech, examples, synonyms | none | Yes | unknown |
| [Indonesia Dictionary](https://new-kbbi-api.herokuapp.com/) | Indonesia dictionary many words | none | Yes | unknown |
...
| [Wiktionary](https://en.wiktionary.org/w/api.php) | Collaborative dictionary data | none | Yes | yes |
...
| [Vector Express v2.0](https://vector.express) | Free vector file converting API | none | Yes | no |
| [WakaTime](https://wakatime.com/developers) | Automated time tracking leaderboards for programmers | none | Yes | unknown |
...
| [KONTESTS](https://kontests.net/api) | For upcoming and ongoing competitive coding contests | none | Yes | unknown |
| [Mintlify](https://docs.mintlify.com) | For programmatically generating documentation for code | `apiKey` | Yes | yes |
| [Brazilian Vehicles and Prices](https://deividfortuna.github.io/fipe/) | Vehicles information from Fundação Instituto de Pesquisas Econômicas - Fipe | none | Yes | no |
...
| [NHTSA](https://vpic.nhtsa.dot.gov/api/) | NHTSA Product Information Catalog and Vehicle Listing | none | Yes | unknown |
...
| [Disify](https://www.disify.com/) | Validate and detect disposable and temporary email addresses | none | Yes | yes |
| [DropMail](https://dropmail.me/api/#live-demo) | GraphQL API for creating and managing ephemeral e-mail inboxes | none | Yes | unknown |
| [EVA](https://eva.pingutil.com/) | Validate email addresses | none | Yes | yes |
| [Guerrilla Mail](https://www.guerrillamail.com/GuerrillaMailAPI.html) | Disposable temporary Email addresses | none | Yes | unknown |
| [ImprovMX](https://improvmx.com/api) | API for free email forwarding service | `apiKey` | Yes | unknown |
| [Kickbox](https://open.kickbox.com/) | Email verification API | none | Yes | yes |
| [mail.gw](https://docs.mail.gw) | 10 Minute Mail | none | Yes | yes |
| [mail.tm](https://docs.mail.tm) | Temporary Email Service | none | Yes | yes |
...
| [MailCheck.ai](https://www.mailcheck.ai/#documentation) | Prevent users to sign up with temporary email addresses | none | Yes | unknown |
...
| [CO2 Offset](https://co2offset.io/api.html) | API calculates and validates the carbon footprint | none | Yes | unknown |
| [Danish data service Energi](https://www.energidataservice.dk/) | Open energy data from Energinet to society | none | Yes | unknown |
| [GrünstromIndex](https://gruenstromindex.de/) | Green Power Index for Germany (Grünstromindex/GSI) | none | No | yes |
| [IQAir](https://www.iqair.com/air-pollution-data-api) | Air quality and weather data | `apiKey` | Yes | unknown |
| [Luchtmeetnet](https://api-docs.luchtmeetnet.nl/) | Predicted and actual air quality components for The Netherlands (RIVM) | none | Yes | unknown |
| [National Grid ESO](https://data.nationalgrideso.com/) | Open data from Great Britain’s Electricity System Operator | none | Yes | unknown |
| [OpenAQ](https://docs.openaq.org/) | Open air quality data | `apiKey` | Yes | unknown |
| [PM2.5 Open Data Portal](https://pm25.lass-net.org/#apis) | Open low-cost PM2.5 sensor data | none | Yes | unknown |
...
| [UK Carbon Intensity](https://carbon-intensity.github.io/api-definitions/#carbon-intensity-api-v1-0-0) | The Official Carbon Intensity API for Great Britain developed by National Grid | none | Yes | unknown |
| [Website Carbon](https://api.websitecarbon.com/) | API to estimate the carbon footprint of loading web pages | none | Yes | unknown |
...
| [Binlist](https://binlist.net/) | Public access to a database of IIN/BIN information | none | Yes | unknown |
...
| [Econdb](https://www.econdb.com/api/) | Global macroeconomic data | none | Yes | yes |
| [Fed Treasury](https://fiscaldata.treasury.gov/api-documentation/) | U.S. Department of the Treasury Data | none | Yes | unknown |
...
| [Indian Mutual Fund](https://www.mfapi.in/) | Get complete history of India Mutual Funds Data | none | Yes | unknown |
...
| [Portfolio Optimizer](https://portfoliooptimizer.io/) | Portfolio analysis and optimization | none | Yes | yes |
| [Razorpay IFSC](https://razorpay.com/docs/) | Indian Financial Systems Code (Bank Branch Codes) | none | Yes | unknown |
...
| [SEC EDGAR Data](https://www.sec.gov/edgar/sec-api-documentation) | API to access annual reports of public US companies | none | Yes | yes |
...
| [WallstreetBets](https://dashboard.nbshare.io/apps/reddit/api/) | WallstreetBets Stock Comments Sentiment Analysis | none | Yes | unknown |
...
| API | Description | Auth | HTTPS | CORS |
| --- | --- | --- | --- | --- |
| [BaconMockup](https://baconmockup.com/) | Resizable bacon placeholder images | none | Yes | yes |
| [Chomp](https://chompthis.com/api/) | Data about various grocery products and foods | `apiKey` | Yes | unknown |
| [Coffee](https://coffee.alexflipnote.dev/) | Random pictures of coffee | none | Yes | unknown |
| [Edamam nutrition](https://developer.edamam.com/edamam-docs-nutrition-api) | Nutrition Analysis | `apiKey` | Yes | unknown |
| [Edamam recipes](https://developer.edamam.com/edamam-docs-recipe-api) | Recipe Search | `apiKey` | Yes | unknown |
| [Foodish](https://github.com/surhud004/Foodish#readme) | Random pictures of food dishes | none | Yes | yes |
| [Fruityvice](https://www.fruityvice.com) | Data about all kinds of fruit | none | Yes | unknown |
| [Kroger](https://developer.kroger.com/reference) | Supermarket Data | `apiKey` | Yes | unknown |
| [LCBO](https://lcboapi.com/) | Alcohol | `apiKey` | Yes | unknown |
| [Open Brewery DB](https://www.openbrewerydb.org) | Breweries, Cideries and Craft Beer Bottle Shops | none | Yes | yes |
| [Open Food Facts](https://world.openfoodfacts.org/data) | Food Products Database | none | Yes | unknown |
| [PunkAPI](https://punkapi.com/) | Brewdog Beer Recipes | none | Yes | unknown |
| [Rustybeer](https://rustybeer.herokuapp.com/) | Beer brewing tools | none | Yes | no |
...
| [TacoFancy](https://github.com/evz/tacofancy-api) | Community-driven taco database | none | No | unknown |
| [Tasty](https://rapidapi.com/apidojo/api/tasty/) | API to query data about recipe, plan, ingredients | `apiKey` | Yes | unknown |
| [The Report of the Week](https://github.com/andyklimczak/TheReportOfTheWeek-API) | Food & Drink Reviews | none | Yes | unknown |
...
| [WhiskyHunter](https://whiskyhunter.net/api/) | Past online whisky auctions statistical data | none | Yes | unknown |
...
| API | Description | Auth | HTTPS | CORS |
| --- | --- | --- | --- | --- |
| [Age of Empires II](https://age-of-empires-2-api.herokuapp.com) | Get information about Age of Empires II resources | none | Yes | no |
| [AmiiboAPI](https://amiiboapi.com/) | Nintendo Amiibo Information | none | Yes | yes |
| [Animal Crossing: New Horizons](http://acnhapi.com/) | API for critters, fossils, art, music, furniture and villagers | none | Yes | unknown |
| [Autochess VNG](https://github.com/didadadida93/autochess-vng-api) | Rest Api for Autochess VNG | none | Yes | yes |
| [Barter.VG](https://github.com/bartervg/barter.vg/wiki) | Provides information about Game, DLC, Bundles, Giveaways, Trading | none | Yes | yes |
...
| [Board Game Geek](https://boardgamegeek.com/wiki/page/BGG_XML_API2) | Board games, RPG and videogames | none | Yes | no |
| [Brawl Stars](https://developer.brawlstars.com) | Brawl Stars Game Information | `apiKey` | Yes | unknown |
| [Bugsnax](https://www.bugsnaxapi.com/) | Get information about Bugsnax | none | Yes | yes |
| [CheapShark](https://www.cheapshark.com/api) | Steam/PC Game Prices and Deals | none | Yes | yes |
| [Chess.com](https://www.chess.com/news/view/published-data-api) | Chess.com read-only REST API | none | Yes | unknown |
| [Chuck Norris Database](http://www.icndb.com/api/) | Jokes | none | No | unknown |
| [Clash of Clans](https://developer.clashofclans.com) | Clash of Clans Game Information | `apiKey` | Yes | unknown |
| [Clash Royale](https://developer.clashroyale.com) | Clash Royale Game Information | `apiKey` | Yes | unknown |
| [Comic Vine](https://comicvine.gamespot.com/api/documentation) | Comics | none | Yes | unknown |
| [Crafatar](https://crafatar.com) | API for Minecraft skins and faces | none | Yes | yes |
| [Cross Universe](https://crossuniverse.psychpsyo.com/apiDocs.html) | Cross Universe Card Data | none | Yes | yes |
| [Deck of Cards](http://deckofcardsapi.com/) | Deck of Cards | none | No | unknown |
| [Destiny The Game](https://bungie-net.github.io/multi/index.html) | Bungie Platform API | `apiKey` | Yes | unknown |
| [Digimon Information](https://digimon-api.vercel.app/) | Provides information about digimon creatures | none | Yes | unknown |
| [Digimon TCG](https://documenter.getpostman.com/view/14059948/TzecB4fH) | Search for Digimon cards in digimoncard.io | none | Yes | unknown |
| [Disney](https://disneyapi.dev) | Information of Disney characters | none | Yes | yes |
...
| [Dungeons and Dragons](https://www.dnd5eapi.co/docs/) | Reference for 5th edition spells, classes, monsters, and more | none | No | no |
| [Dungeons and Dragons (Alternate)](https://open5e.com/) | Includes all monsters and spells from the SRD (System Reference Document) as well as a search API | none | Yes | yes |
| [Eve Online](https://esi.evetech.net/ui) | Third-Party Developer Documentation | `OAuth` | Yes | unknown |
| [FFXIV Collect](https://ffxivcollect.com/) | Final Fantasy XIV data on collectables | none | Yes | yes |
| [FIFA Ultimate Team](https://www.easports.com/fifa/ultimate-team/api/fut/item) | FIFA Ultimate Team items API | none | Yes | unknown |
| [Final Fantasy XIV](https://xivapi.com/) | Final Fantasy XIV Game data API | none | Yes | yes |
| [Fortnite](https://fortnitetracker.com/site-api) | Fortnite Stats | `apiKey` | Yes | unknown |
| [Forza](https://docs.forza-api.tk) | Show random image of car from Forza | none | Yes | unknown |
| [FreeToGame](https://www.freetogame.com/api-doc) | Free-To-Play Games Database | none | Yes | yes |
| [Fun Facts](https://asli-fun-fact-api.herokuapp.com/) | Random Fun Facts | none | Yes | yes |
| [FunTranslations](https://api.funtranslations.com/) | Translate Text into funny languages | none | Yes | yes |
| [GamerPower](https://www.gamerpower.com/api-read) | Game Giveaways Tracker | none | Yes | yes |
| [GDBrowser](https://gdbrowser.com/api) | Easy way to use the Geometry Dash Servers | none | Yes | unknown |
| [Geek-Jokes](https://github.com/sameerkumar18/geek-joke-api) | Fetch a random geeky/programming related joke for use in all sorts of applications | none | Yes | yes |
| [Genshin Impact](https://genshin.dev) | Genshin Impact game data | none | Yes | yes |
| [Giant Bomb](https://www.giantbomb.com/api/documentation) | Video Games | `apiKey` | Yes | unknown |
| [GraphQL Pokemon](https://github.com/favware/graphql-pokemon) | GraphQL powered Pokemon API. Supports generations 1 through 8 | none | Yes | yes |
| [Guild Wars 2](https://wiki.guildwars2.com/wiki/API:Main) | Guild Wars 2 Game Information | `apiKey` | Yes | unknown |
| [GW2Spidy](https://github.com/rubensayshi/gw2spidy/wiki) | GW2Spidy API, Items data on the Guild Wars 2 Trade Market | none | Yes | unknown |
...
| [Hyrule Compendium](https://github.com/gadhagod/Hyrule-Compendium-API) | Data on all interactive items from The Legend of Zelda: BOTW | none | Yes | unknown |
| [Hytale](https://hytale-api.com/) | Hytale blog posts and jobs | none | Yes | unknown |
| [IGDB.com](https://api-docs.igdb.com) | Video Game Database | `apiKey` | Yes | unknown |
| [JokeAPI](https://sv443.net/jokeapi/v2/) | Programming, Miscellaneous and Dark Jokes | none | Yes | yes |
| [Jokes One](https://jokes.one/api/joke/) | Joke of the day and large category of jokes accessible via REST API | `apiKey` | Yes | yes |
| [Jservice](http://jservice.io) | Jeopardy Question Database | none | No | unknown |
| [Lichess](https://lichess.org/api) | Access to all data of users, games, puzzles and etc on Lichess | `OAuth` | Yes | unknown |
| [Magic The Gathering](http://magicthegathering.io/) | Magic The Gathering Game Information | none | No | unknown |
...
| [Minecraft Server Status](https://api.mcsrvstat.us) | API to get Information about a Minecraft Server | none | Yes | no |
| [MMO Games](https://www.mmobomb.com/api) | MMO Games Database, News and Giveaways | none | Yes | no |
| [mod.io](https://docs.mod.io) | Cross Platform Mod API | `apiKey` | Yes | unknown |
| [Mojang](https://wiki.vg/Mojang_API) | Mojang / Minecraft API | `apiKey` | Yes | unknown |
| [Monster Hunter World](https://docs.mhw-db.com/) | Monster Hunter World data | none | Yes | yes |
| [Open Trivia](https://opentdb.com/api_config.php) | Trivia Questions | none | Yes | unknown |
...
| [PlayerDB](https://playerdb.co/) | Query Minecraft, Steam and XBox Accounts | none | Yes | unknown |
| [Pokéapi](https://pokeapi.co) | Pokémon Information | none | Yes | unknown |
| [PokéAPI (GraphQL)](https://github.com/mazipan/graphql-pokeapi) | The Unofficial GraphQL for PokeAPI | none | Yes | yes |
| [Pokémon TCG](https://pokemontcg.io) | Pokémon TCG Information | none | Yes | unknown |
| [Psychonauts](https://psychonauts-api.netlify.app/) | Psychonauts World Characters Information and PSI Powers | none | Yes | yes |
| [PUBG](https://developer.pubg.com/) | Access in-game PUBG data | `apiKey` | Yes | yes |
| [Puyo Nexus](https://github.com/deltadex7/puyodb-api-deno) | Puyo Puyo information from Puyo Nexus Wiki | none | Yes | yes |
| [quizapi.io](https://quizapi.io/) | Access to various kind of quiz questions | `apiKey` | Yes | yes |
| [Raider](https://raider.io/api) | Provides detailed character and guild rankings for Raiding and Mythic+ content in World of Warcraft | none | Yes | unknown |
| [RAWG.io](https://rawg.io/apidocs) | 500,000+ games for 50 platforms including mobiles | `apiKey` | Yes | unknown |
| [Rick and Morty](https://rickandmortyapi.com) | All the Rick and Morty information, including images | none | Yes | yes |
| [Riot Games](https://developer.riotgames.com/) | League of Legends Game Information | `apiKey` | Yes | unknown |
| [RPS 101](https://rps101.pythonanywhere.com/api) | Rock, Paper, Scissors with 101 objects | none | Yes | yes |
| [RuneScape](https://runescape.wiki/w/Application_programming_interface) | RuneScape and OSRS RPGs information | none | Yes | no |
| [Sakura CardCaptor](https://github.com/JessVel/sakura-card-captor-api) | Sakura CardCaptor Cards Information | none | Yes | unknown |
| [Scryfall](https://scryfall.com/docs/api) | Magic: The Gathering database | none | Yes | yes |
...
| [TCGdex](https://www.tcgdex.net/docs) | Multi languages Pokémon TCG Information | none | Yes | yes |
| [Tebex](https://docs.tebex.io/plugin/) | Tebex API for information about game purchases | `X-Mashape-Key` | Yes | no |
| [TETR.IO](https://tetr.io/about/api/) | TETR.IO Tetra Channel API | none | Yes | unknown |
| [Tronald Dump](https://www.tronalddump.io/) | The dumbest things Donald Trump has ever said | none | Yes | unknown |
| [Universalis](https://universalis.app/docs/index.html) | Final Fantasy XIV market board data | none | Yes | yes |
| [Valorant (non-official)](https://valorant-api.com) | An extensive API containing data of most Valorant in-game items, assets and more | none | Yes | unknown |
| [Warface (non-official)](https://api.wfstats.cf) | Official API proxy with better data structure and more features | none | Yes | no |
| [Wargaming.net](https://developers.wargaming.net/) | Wargaming.net info and stats | `apiKey` | Yes | no |
| [When is next MCU film](https://github.com/DiljotSG/MCU-Countdown/blob/develop/docs/API.md) | Upcoming MCU film information | none | Yes | unknown |
| [xkcd](https://xkcd.com/json.html) | Retrieve xkcd comics as JSON | none | Yes | no |
| [Yu-Gi-Oh!](https://db.ygoprodeck.com/api-guide/) | Yu-Gi-Oh! TCG Information | none | Yes | unknown |
...
| [administrative-divisons-db](https://github.com/kamikazechaser/administrative-divisions-db) | Get all administrative divisions of a country | none | Yes | yes |
| [adresse.data.gouv.fr](https://adresse.data.gouv.fr) | Address database of France, geocoding and reverse | none | Yes | unknown |
| [Airtel IP](https://sys.airtel.lv/ip2country/1.1.1.1/?full=true) | IP Geolocation API. Collecting data from multiple sources | none | Yes | unknown |
...
| [bng2latlong](https://www.getthedata.com/bng2latlong) | Convert British OSGB36 easting and northing (British National Grid) to WGS84 latitude and longitude | none | Yes | yes |
| [Cartes.io](https://github.com/M-Media-Group/Cartes.io/wiki/API) | Create maps and markers for anything | none | Yes | unknown |
| [Cep.la](http://cep.la/) | Brazil RESTful API to find information about streets, zip codes, neighborhoods, cities and states | none | No | unknown |
| [CitySDK](http://www.citysdk.eu/citysdk-toolkit/) | Open APIs for select European cities | none | Yes | unknown |
| [Country](http://country.is/) | Get your visitor's country from their IP | none | Yes | yes |
...
| [Ducks Unlimited](https://gis.ducks.org/datasets/du-university-chapters/api) | API explorer that gives a query URL with a JSON response of locations and cities | none | Yes | no |
| [GeoApi](https://api.gouv.fr/api/geoapi.html) | French geographical data | none | Yes | unknown |
...
| [Geocode.xyz](https://geocode.xyz/api) | Provides worldwide forward/reverse geocoding, batch geocoding and geoparsing | none | Yes | unknown |
| [Geocodify.com](https://geocodify.com/) | Worldwide geocoding, geoparsing and autocomplete for addresses | `apiKey` | Yes | yes |
| [Geodata.gov.gr](https://geodata.gov.gr/en/) | Open geospatial data and API service for Greece | none | Yes | unknown |
...
| [GeographQL](https://geographql.netlify.app) | A Country, State, and City GraphQL API | none | Yes | yes |
| [GeoJS](https://www.geojs.io/) | IP geolocation with ChatOps integration | none | Yes | yes |
| [Geokeo](https://geokeo.com) | Geokeo geocoding service- with 2500 free api requests daily | none | Yes | yes |
| [GeoNames](http://www.geonames.org/export/web-services.html) | Place names and other geographical data | none | No | unknown |
| [geoPlugin](https://www.geoplugin.com) | IP geolocation and currency conversion | none | Yes | yes |
...
| [Graph Countries](https://github.com/lennertVanSever/graphcountries) | Country-related data like currencies, languages, flags, regions+subregions and bordering countries | none | Yes | unknown |
| [HelloSalut](https://fourtonfish.com/project/hellosalut-api/) | Get hello translation following user language | none | Yes | unknown |
...
| [Hong Kong GeoData Store](https://geodata.gov.hk/gs/) | API for accessing geo-data of Hong Kong | none | Yes | unknown |
| [IBGE](https://servicodados.ibge.gov.br/api/docs/) | Aggregate services of IBGE (Brazilian Institute of Geography and Statistics) | none | Yes | unknown |
| [IP 2 Country](https://ip2country.info) | Map an IP to a country | none | Yes | unknown |
| [IP Address Details](https://ipinfo.io/) | Find geolocation with ip address | none | Yes | unknown |
| [IP Vigilante](https://www.ipvigilante.com/) | Free IP Geolocation API | none | Yes | unknown |
| [ip-api](https://ip-api.com/docs) | Find location with IP address or domain | none | No | unknown |
| [IP2Location](https://www.ip2location.com/web-service/ip2location) | IP geolocation web service to get more than 55 parameters | `apiKey` | Yes | unknown |
| [IP2Proxy](https://www.ip2location.com/web-service/ip2proxy) | Detect proxy and VPN using IP address | `apiKey` | Yes | unknown |
| [ipapi.co](https://ipapi.co/api/#introduction) | Find IP address location information | none | Yes | yes |
| [ipapi.com](https://ipapi.com/) | Real-time Geolocation & Reverse IP Lookup REST API | `apiKey` | Yes | unknown |
| [IPGEO](https://api.techniknews.net/ipgeo/) | Unlimited free IP Address API with useful information | none | Yes | unknown |
...
| [Mexico](https://github.com/IcaliaLabs/sepomex) | Mexico RESTful zip codes API | none | Yes | unknown |
| [Nominatim](https://nominatim.org/release-docs/latest/api/Overview/) | Provides worldwide forward / reverse geocoding | none | Yes | yes |
...
| [OnWater](https://onwater.io/) | Determine if a lat/lon is on water or land | none | Yes | unknown |
| [Open Topo Data](https://www.opentopodata.org) | Elevation and ocean depth for a latitude and longitude | none | Yes | no |
...
| [Pinball Map](https://pinballmap.com/api/v1/docs) | A crowdsourced map of public pinball machines | none | Yes | yes |
| [positionstack](https://positionstack.com/) | Forward & Reverse Batch Geocoding REST API | `apiKey` | Yes | unknown |
| [Postali](https://postali.app/api) | Mexico Zip Codes API | none | Yes | yes |
| [PostcodeData.nl](http://api.postcodedata.nl/v1/postcode/?postcode=1211EP&streetnumber=60&ref=domeinnaam.nl&type=json) | Provide geolocation data based on postcode for Dutch addresses | none | No | unknown |
| [Postcodes.io](https://postcodes.io) | Postcode lookup & Geolocation for the UK | none | Yes | yes |
| [Queimadas INPE](https://queimadas.dgi.inpe.br/queimadas/dados-abertos/) | Access to heat focus data (probable wildfire) | none | Yes | unknown |
| [REST Countries](https://restcountries.com) | Get information about countries via a RESTful API | none | Yes | yes |
| [RoadGoat Cities](https://www.roadgoat.com/business/cities-api) | Cities content & photos API | `apiKey` | Yes | no |
| [Rwanda Locations](https://rapidapi.com/victorkarangwa4/api/rwanda) | Rwanda Provences, Districts, Cities, Capital City, Sector, cells, villages and streets | none | Yes | unknown |
| [SLF](https://github.com/slftool/slftool.github.io/blob/master/API.md) | German city, country, river, database | none | Yes | yes |
...
| [ViaCep](https://viacep.com.br) | Brazil RESTful zip codes API | none | Yes | unknown |
...
| [Zippopotam.us](http://www.zippopotam.us) | Get information about place such as country, city, state, etc | none | No | unknown |
| [Ziptastic](https://ziptasticapi.com/) | Get the country, state, and city of any US zip-code | none | Yes | unknown |
...
| API | Description | Auth | HTTPS | CORS |
| --- | --- | --- | --- | --- |
| [Bank Negara Malaysia Open Data](https://apikijangportal.bnm.gov.my/) | Malaysia Central Bank Open Data | none | Yes | unknown |
| [BCLaws](https://www.bclaws.gov.bc.ca/civix/template/complete/api/index.html) | Access to the laws of British Columbia | none | No | unknown |
| [Brazil](https://brasilapi.com.br/) | Community driven API for Brazil Public Data | none | Yes | yes |
| [Brazil Central Bank Open Data](https://dadosabertos.bcb.gov.br/) | Brazil Central Bank Open Data | none | Yes | unknown |
| [Brazil Receita WS](https://www.receitaws.com.br/) | Consult companies by CNPJ for Brazilian companies | none | Yes | unknown |
| [Brazilian Chamber of Deputies Open Data](https://dadosabertos.camara.leg.br/swagger/api.html) | Provides legislative information in Apis XML and JSON, as well as files in various formats | none | Yes | no |
| [Census.gov](https://www.census.gov/data/developers/data-sets.html) | The US Census Bureau provides various APIs and data sets on demographics and businesses | none | Yes | unknown |
| [City, Berlin](https://daten.berlin.de/) | Berlin(DE) City Open Data | none | Yes | unknown |
| [City, Gdańsk](https://ckan.multimediagdansk.pl/en) | Gdańsk (PL) City Open Data | none | Yes | unknown |
| [City, Gdynia](http://otwartedane.gdynia.pl/en/api_doc.html) | Gdynia (PL) City Open Data | none | No | unknown |
| [City, Helsinki](https://hri.fi/en_gb/) | Helsinki(FI) City Open Data | none | Yes | unknown |
| [City, Lviv](https://opendata.city-adm.lviv.ua/) | Lviv(UA) City Open Data | none | Yes | unknown |
| [City, Nantes Open Data](https://data.nantesmetropole.fr/pages/home/) | Nantes(FR) City Open Data | `apiKey` | Yes | unknown |
| [City, New York Open Data](https://opendata.cityofnewyork.us/) | New York (US) City Open Data | none | Yes | unknown |
| [City, Prague Open Data](http://opendata.praha.eu/en) | Prague(CZ) City Open Data | none | No | unknown |
| [City, Toronto Open Data](https://open.toronto.ca/) | Toronto (CA) City Open Data | none | Yes | yes |
...
| [Colorado Information Marketplace](https://data.colorado.gov/) | Colorado State Government Open Data | none | Yes | unknown |
| [Data USA](https://datausa.io/about/api/) | US Public Data | none | Yes | unknown |
| [Data.gov](https://api.data.gov/) | US Government Data | `apiKey` | Yes | unknown |
| [Data.parliament.uk](https://explore.data.parliament.uk/?learnmore=Members) | Contains live datasets including information about petitions, bills, MP votes, attendance and more | none | No | unknown |
...
| [District of Columbia Open Data](http://opendata.dc.gov/pages/using-apis) | Contains D.C. government public datasets, including crime, GIS, financial data, and so on | none | Yes | unknown |
| [EPA](https://www.epa.gov/developers/data-data-products#apis) | Web services and data sets from the US Environmental Protection Agency | none | Yes | unknown |
| [FBI Wanted](https://www.fbi.gov/wanted/api) | Access information on the FBI Wanted program | none | Yes | unknown |
| [FEC](https://api.open.fec.gov/developers/) | Information on campaign donations in federal elections | `apiKey` | Yes | unknown |
| [Federal Register](https://www.federalregister.gov/reader-aids/developer-resources/rest-api) | The Daily Journal of the United States Government | none | Yes | unknown |
| [Food Standards Agency](http://ratings.food.gov.uk/open-data/en-GB) | UK food hygiene rating data API | none | No | unknown |
...
| [INEI](http://iinei.inei.gob.pe/microdatos/) | Peruvian Statistical Government Open Data | none | No | unknown |
| [Interpol Red Notices](https://interpol.api.bund.dev/) | Access and search Interpol Red Notices | none | Yes | unknown |
| [Istanbul (İBB) Open Data](https://data.ibb.gov.tr) | Data sets from the İstanbul Metropolitan Municipality (İBB) | none | Yes | unknown |
| [National Park Service, US](https://www.nps.gov/subjects/developer/) | Data from the US National Park Service | `apiKey` | Yes | yes |
| [Open Government, ACT](https://www.data.act.gov.au/) | Australian Capital Territory Open Data | none | Yes | unknown |
| [Open Government, Argentina](https://datos.gob.ar/) | Argentina Government Open Data | none | Yes | unknown |
| [Open Government, Australia](https://www.data.gov.au/) | Australian Government Open Data | none | Yes | unknown |
| [Open Government, Austria](https://www.data.gv.at/) | Austria Government Open Data | none | Yes | unknown |
| [Open Government, Belgium](https://data.gov.be/) | Belgium Government Open Data | none | Yes | unknown |
| [Open Government, Canada](http://open.canada.ca/en) | Canadian Government Open Data | none | No | unknown |
| [Open Government, Colombia](https://www.dane.gov.co/) | Colombia Government Open Data | none | No | unknown |
| [Open Government, Cyprus](https://data.gov.cy/?language=en) | Cyprus Government Open Data | none | Yes | unknown |
| [Open Government, Czech Republic](https://data.gov.cz/english/) | Czech Republic Government Open Data | none | Yes | unknown |
| [Open Government, Denmark](https://www.opendata.dk/) | Denmark Government Open Data | none | Yes | unknown |
...
| [Open Government, Finland](https://www.avoindata.fi/en) | Finland Government Open Data | none | Yes | unknown |
| [Open Government, France](https://www.data.gouv.fr/) | French Government Open Data | `apiKey` | Yes | unknown |
| [Open Government, Germany](https://www.govdata.de/daten/-/details/govdata-metadatenkatalog) | Germany Government Open Data | none | Yes | unknown |
...
| [Open Government, Ireland](https://data.gov.ie/pages/developers) | Ireland Government Open Data | none | Yes | unknown |
| [Open Government, Italy](https://www.dati.gov.it/) | Italy Government Open Data | none | Yes | unknown |
| [Open Government, Korea](https://www.data.go.kr/) | Korea Government Open Data | `apiKey` | Yes | unknown |
| [Open Government, Lithuania](https://data.gov.lt/public/api/1) | Lithuania Government Open Data | none | Yes | unknown |
| [Open Government, Luxembourg](https://data.public.lu) | Luxembourgish Government Open Data | `apiKey` | Yes | unknown |
| [Open Government, Mexico](https://www.inegi.org.mx/datos/) | Mexican Statistical Government Open Data | none | Yes | unknown |
| [Open Government, Netherlands](https://data.overheid.nl/en/ondersteuning/data-publiceren/api) | Netherlands Government Open Data | none | Yes | unknown |
| [Open Government, New South Wales](https://api.nsw.gov.au/) | New South Wales Government Open Data | `apiKey` | Yes | unknown |
| [Open Government, New Zealand](https://www.data.govt.nz/) | New Zealand Government Open Data | none | Yes | unknown |
| [Open Government, Norway](https://data.norge.no/dataservices) | Norwegian Government Open Data | none | Yes | yes |
| [Open Government, Peru](https://www.datosabiertos.gob.pe/) | Peru Government Open Data | none | Yes | unknown |
| [Open Government, Poland](https://dane.gov.pl/en) | Poland Government Open Data | none | Yes | yes |
| [Open Government, Portugal](https://dados.gov.pt/en/docapi/) | Portugal Government Open Data | none | Yes | yes |
| [Open Government, Queensland Government](https://www.data.qld.gov.au/) | Queensland Government Open Data | none | Yes | unknown |
| [Open Government, Romania](http://data.gov.ro/) | Romania Government Open Data | none | No | unknown |
| [Open Government, Saudi Arabia](https://data.gov.sa) | Saudi Arabia Government Open Data | none | Yes | unknown |
| [Open Government, Singapore](https://data.gov.sg/developer) | Singapore Government Open Data | none | Yes | unknown |
| [Open Government, Slovakia](https://data.gov.sk/en/) | Slovakia Government Open Data | none | Yes | unknown |
| [Open Government, Slovenia](https://podatki.gov.si/) | Slovenia Government Open Data | none | Yes | no |
| [Open Government, South Australian Government](https://data.sa.gov.au/) | South Australian Government Open Data | none | Yes | unknown |
| [Open Government, Spain](https://datos.gob.es/en) | Spain Government Open Data | none | Yes | unknown |
| [Open Government, Sweden](https://www.dataportal.se/en/dataservice/91_29789/api-for-the-statistical-database) | Sweden Government Open Data | none | Yes | unknown |
| [Open Government, Switzerland](https://handbook.opendata.swiss/de/content/nutzen/api-nutzen.html) | Switzerland Government Open Data | none | Yes | unknown |
| [Open Government, Taiwan](https://data.gov.tw/) | Taiwan Government Open Data | none | Yes | unknown |
| [Open Government, Thailand](https://data.go.th/) | Thailand Government Open Data | `apiKey` | Yes | unknown |
| [Open Government, UK](https://data.gov.uk/) | UK Government Open Data | none | Yes | unknown |
| [Open Government, USA](https://www.data.gov/) | United States Government Open Data | none | Yes | unknown |
| [Open Government, Victoria State Government](https://www.data.vic.gov.au/) | Victoria State Government Open Data | none | Yes | unknown |
| [Open Government, West Australia](https://data.wa.gov.au/) | West Australia Open Data | none | Yes | unknown |
| [PRC Exam Schedule](https://api.whenisthenextboardexam.com/docs/) | Unofficial Philippine Professional Regulation Commission's examination schedule | none | Yes | yes |
| [Represent by Open North](https://represent.opennorth.ca/) | Find Canadian Government Representatives | none | Yes | unknown |
...
| [US Presidential Election Data by TogaTech](https://uselection.togatech.org/api/) | Basic candidate data and live electoral vote counts for top two parties in US presidential election | none | Yes | no |
...
| [USAspending.gov](https://api.usaspending.gov/) | US federal spending data | none | Yes | unknown |
...
| [Coronavirus](https://pipedream.com/@pravin/http-api-for-latest-wuhan-coronavirus-data-2019-ncov-p_G6CLVM/readme) | HTTP API for Latest Covid-19 Data | none | Yes | unknown |
| [Coronavirus in the UK](https://coronavirus.data.gov.uk/details/developers-guide) | UK Government coronavirus data, including deaths and cases by region | none | Yes | unknown |
| [Covid Tracking Project](https://covidtracking.com/data/api/version-2) | Covid-19  data for the US | none | Yes | no |
| [Covid-19](https://covid19api.com/) | Covid 19 spread, infection and recovery | none | Yes | yes |
| [Covid-19 Datenhub](https://npgeo-corona-npgeo-de.hub.arcgis.com) | Maps, datasets, applications and more in the context of COVID-19 | none | Yes | unknown |
| [Covid-19 Government Response](https://covidtracker.bsg.ox.ac.uk) | Government measures tracker to fight against the Covid-19 pandemic | none | Yes | yes |
| [Covid-19 India](https://data.covid19india.org/) | Covid 19 statistics state and district wise about cases, vaccinations, recovery within India | none | Yes | unknown |
| [Covid-19 JHU CSSE](https://nuttaphat.com/covid19-api/) | Open-source API for exploring Covid19 cases based on JHU CSSE | none | Yes | yes |
| [Covid-19 Live Data](https://github.com/mathdroid/covid-19-api) | Global and countrywise data of Covid 19 daily Summary, confirmed cases, recovered and deaths | none | Yes | yes |
| [Covid-19 Philippines](https://github.com/Simperfy/Covid-19-API-Philippines-DOH) | Unofficial Covid-19 Web API for Philippines from data collected by DOH | none | Yes | yes |
| [COVID-19 Tracker Canada](https://api.covid19tracker.ca/docs/1.0/overview) | Details on Covid-19 cases across Canada | none | Yes | unknown |
| [COVID-19 Tracker Sri Lanka](https://www.hpb.health.gov.lk/en/api-documentation) | Provides situation of the COVID-19 patients reported in Sri Lanka | none | Yes | unknown |
| [COVID-ID](https://data.covid19.go.id/public/api/prov.json) | Indonesian government Covid data per province | none | Yes | yes |
| [Dataflow Kit COVID-19](https://covid-19.dataflowkit.com) | COVID-19 live statistics into sites per hour | none | Yes | unknown |
| [FoodData Central](https://fdc.nal.usda.gov/) | National Nutrient Database for Standard Reference | `apiKey` | Yes | unknown |
| [Healthcare.gov](https://www.healthcare.gov/developers/) | Educational content about the US Health Insurance Marketplace | none | Yes | unknown |
| [Humanitarian Data Exchange](https://data.humdata.org/) | Humanitarian Data Exchange (HDX) is open platform for sharing data across crises and organisations | none | Yes | unknown |
...
| [LAPIS](https://cov-spectrum.ethz.ch/public) | SARS-CoV-2 genomic sequences from public sources | none | Yes | yes |
...
| [Makeup](http://makeup-api.herokuapp.com/) | Makeup Information | none | No | unknown |
| [MyVaccination](https://documenter.getpostman.com/view/16605343/Tzm8GG7u) | Vaccination data for Malaysia | none | Yes | unknown |
| [NPPES](https://npiregistry.cms.hhs.gov/registry/help-api) | National Plan & Provider Enumeration System, info on healthcare providers registered in US | none | Yes | unknown |
| [Nutritionix](https://developer.nutritionix.com/) | Worlds largest verified nutrition database | `apiKey` | Yes | unknown |
| [Open Data NHS Scotland](https://www.opendata.nhs.scot) | Medical reference data and statistics by Public Health Scotland | none | Yes | unknown |
| [Open Disease](https://disease.sh/) | API for Current cases and more stuff about COVID-19 and Influenza | none | Yes | yes |
...
| [Quarantine](https://quarantine.country/coronavirus/api/) | Coronavirus API with free COVID-19 live updates | none | Yes | yes |
...
| [Arbeitnow](https://documenter.getpostman.com/view/18545278/UVJbJdKh) | API for Job board aggregator in Europe / Remote | none | Yes | yes |
...
| [DevITjobs UK](https://devitjobs.uk/job_feed.xml) | Jobs with GraphQL | none | Yes | yes |
| [Findwork](https://findwork.dev/developers/) | Job board | `apiKey` | Yes | unknown |
| [GraphQL Jobs](https://graphql.jobs/docs/api/) | Jobs with GraphQL | none | Yes | yes |
| [Jobs2Careers](http://api.jobs2careers.com/api/spec.pdf) | Job aggregator | `apiKey` | Yes | unknown |
| [Jooble](https://jooble.org/api/about) | Job search engine | `apiKey` | Yes | unknown |
| [Juju](http://www.juju.com/publisher/spec/) | Job search engine | `apiKey` | No | unknown |
| [Open Skills](https://github.com/workforce-data-initiative/skills-api/wiki/API-Overview) | Job titles, skills and related jobs data | none | No | unknown |
...
| [Chainlink](https://chain.link/developer-resources) | Build hybrid smart contracts with Chainlink | none | Yes | unknown |
| [Chainpoint](https://tierion.com/chainpoint/) | Chainpoint is a global network for anchoring data to the Bitcoin blockchain | none | Yes | unknown |
| [Covalent](https://www.covalenthq.com/docs/api/) | Multi-blockchain data aggregator platform | `apiKey` | Yes | unknown |
| [Etherscan](https://etherscan.io/apis) | Ethereum explorer API | `apiKey` | Yes | yes |
| [Helium](https://docs.helium.com/api/blockchain/introduction/) | Helium is a global, distributed network of Hotspots that create public, long-range wireless coverage | none | Yes | unknown |
| [Nownodes](https://nownodes.io/) | Blockchain-as-a-service solution that provides high-quality connection via API | `apiKey` | Yes | unknown |
| [Steem](https://developers.steem.io/) | Blockchain-based blogging and social media website | none | No | no |
| [The Graph](https://thegraph.com) | Indexing protocol for querying networks like Ethereum with GraphQL | `apiKey` | Yes | unknown |
| [Walltime](https://walltime.info/api.html) | To retrieve Walltime's market info | none | Yes | unknown |
| [Watchdata](https://docs.watchdata.io) | Provide simple and reliable API access to Ethereum blockchain | `apiKey` | Yes | unknown |
| [chucknorris.io](https://api.chucknorris.io) | JSON API for hand curated Chuck Norris jokes | none | Yes | unknown |
| [Corporate Buzz Words](https://github.com/sameerkumar18/corporate-bs-generator-api) | REST API for Corporate Buzz Words | none | Yes | yes |
| [Excuser](https://excuser.herokuapp.com/) | Get random excuses for various situations | none | Yes | unknown |
| [Fun Fact](https://api.aakhilv.me) | A simple HTTPS api that can randomly select and return a fact from the FFA database | none | Yes | yes |
| [Imgflip](https://imgflip.com/api) | Gets an array of popular memes | none | Yes | unknown |
| [Meme Maker](https://mememaker.github.io/API/) | REST API for create your own meme | none | Yes | unknown |
| [NaMoMemes](https://github.com/theIYD/NaMoMemes) | Memes on Narendra Modi | none | Yes | unknown |
| [Random Useless Facts](https://uselessfacts.jsph.pl/) | Get useless, but true facts | none | Yes | unknown |
| [Techy](https://techy-api.vercel.app/) | JSON and Plaintext API for tech-savvy sounding phrases | none | Yes | unknown |
| [Yo Momma Jokes](https://github.com/beanboi7/yomomma-apiv2) | REST API for Yo Momma Jokes | none | Yes | unknown |
...
| [Deepcode](https://www.deepcode.ai) | AI for code review | none | Yes | unknown |
| [Dialogflow](https://cloud.google.com/dialogflow/docs/) | Natural Language Processing | `apiKey` | Yes | unknown |
| [EXUDE-API](http://uttesh.com/exude-api/) | Used for the primary ways for filtering the stopping, stemming words from the text data | none | Yes | yes |
...
| [OpenVisionAPI](https://openvisionapi.com) | Open source computer vision API based on open source models | none | Yes | yes |
...
| [Bandsintown](https://app.swaggerhub.com/apis/Bandsintown/PublicAPI/3.0.0) | Music Events | none | Yes | unknown |
...
| [Gaana](https://github.com/cyberboysumanjay/GaanaAPI) | API to retrieve song information from Gaana | none | Yes | unknown |
| [Genius](https://docs.genius.com/) | Crowdsourced lyrics and music knowledge | `OAuth` | Yes | unknown |
| [Genrenator](https://binaryjazz.us/genrenator-api/) | Music genre generator | none | Yes | unknown |
| [iTunes Search](https://affiliate.itunes.apple.com/resources/documentation/itunes-store-web-service-search-api/) | Software products | none | Yes | unknown |
| [Jamendo](https://developer.jamendo.com/v3.0/docs) | Music | `OAuth` | Yes | unknown |
| [JioSaavn](https://github.com/cyberboysumanjay/JioSaavnAPI) | API to retrieve song information, album meta data and many more from JioSaavn | none | Yes | unknown |
...
| [Lyrics.ovh](https://lyricsovh.docs.apiary.io) | Simple API to retrieve the lyrics of a song | none | Yes | unknown |
| [Mixcloud](https://www.mixcloud.com/developers/) | Music | `OAuth` | Yes | yes |
| [MusicBrainz](https://musicbrainz.org/doc/Development/XML_Web_Service/Version_2) | Music | none | Yes | unknown |
...
| [Openwhyd](https://openwhyd.github.io/openwhyd/API) | Download curated playlists of streaming tracks (YouTube, SoundCloud, etc...) | none | Yes | no |
...
| [Radio Browser](https://api.radio-browser.info/) | List of internet radio stations | none | Yes | yes |
...
| [Songsterr](https://www.songsterr.com/a/wa/api/) | Provides guitar, bass and drums tabs and chords | none | Yes | unknown |
...
| [Chronicling America](http://chroniclingamerica.loc.gov/about/api/) | Provides access to millions of pages of historic US newspapers from the Library of Congress | none | No | unknown |
...
| [Graphs for Coronavirus](https://corona.dnsforfamily.com/api.txt) | Each Country separately and Worldwide Graphs for Coronavirus. Daily updates | none | Yes | yes |
| [Inshorts News](https://github.com/cyberboysumanjay/Inshorts-News-API) | Provides news from inshorts | none | Yes | unknown |
...
| [Spaceflight News](https://spaceflightnewsapi.net) | Spaceflight related news 🚀 | none | Yes | yes |
...
| API | Description | Auth | HTTPS | CORS |
| --- | --- | --- | --- | --- |
| [18F](http://18f.github.io/API-All-the-X/) | Unofficial US Federal Government API Development | none | No | unknown |
| [API Setu](https://www.apisetu.gov.in/) | An Indian Government platform that provides a lot of APIS for KYC, business, education & employment | none | Yes | yes |
| [Archive.org](https://archive.readme.io/docs) | The Internet Archive | none | Yes | no |
...
| [BotsArchive](https://botsarchive.com/docs.html) | JSON formatted details about Telegram Bots available in database | none | Yes | unknown |
| [Callook.info](https://callook.info) | United States ham radio callsigns | none | Yes | unknown |
| [CARTO](https://carto.com/) | Location Information Prediction | `apiKey` | Yes | unknown |
| [CollegeScoreCard.ed.gov](https://collegescorecard.ed.gov/data/) | Data on higher education institutions in the United States | none | Yes | unknown |
| [Enigma Public](https://developers.enigma.com/docs) | Broadest collection of public data | `apiKey` | Yes | yes |
| [French Address Search](https://geo.api.gouv.fr/adresse) | Address search via the French Government | none | Yes | unknown |
...
| [Lowy Asia Power Index](https://github.com/0x0is1/lowy-index-api-docs) | Get measure resources and influence to rank the relative power of states in Asia | none | Yes | unknown |
| [Microlink.io](https://microlink.io) | Extract structured data from any website | none | Yes | yes |
| [Nasdaq Data Link](https://docs.data.nasdaq.com/) | Stock market data | `apiKey` | Yes | unknown |
| [Nobel Prize](https://www.nobelprize.org/about/developer-zone-2/) | Open data about nobel prizes and events | none | Yes | yes |
| [Open Data Minneapolis](https://opendata.minneapolismn.gov/) | Spatial (GIS) and non-spatial city data for Minneapolis | none | Yes | no |
| [openAFRICA](https://africaopendata.org/) | Large datasets repository of African open data | none | Yes | unknown |
...
| [OpenSanctions](https://www.opensanctions.org/docs/api/) | Data on international sanctions, crime and politically exposed persons | none | Yes | yes |
...
| [Teleport](https://developers.teleport.org/) | Quality of Life Data | none | Yes | unknown |
| [Umeå Open Data](https://opendata.umea.se/api/) | Open data of the city Umeå in northen Sweden | none | Yes | yes |
| [Universities List](https://github.com/Hipo/university-domains-list) | University names, countries and domains | none | Yes | unknown |
| [University of Oslo](https://data.uio.no/) | Courses, lecture videos, detailed information for courses etc. for the University of Oslo (Norway) | none | Yes | unknown |
...
| [Urban Observatory](https://urbanobservatory.ac.uk) | The largest set of publicly available real time urban data in the UK | none | No | no |
...
| [Wikipedia](https://www.mediawiki.org/wiki/API:Main_page) | Mediawiki Encyclopedia | none | Yes | unknown |
...
| API | Description | Auth | HTTPS | CORS |
| --- | --- | --- | --- | --- |
| [Countly](https://api.count.ly/reference) | Countly web analytics | none | No | unknown |
...
| [Datamuse](https://www.datamuse.com/api/) | Word-finding query engine | none | Yes | unknown |
| [Drupal.org](https://www.drupal.org/drupalorg/docs/api) | Drupal.org | none | Yes | unknown |
| [Evil Insult Generator](https://evilinsult.com/api) | Evil Insults | none | Yes | yes |
| [GitHub Contribution Chart Generator](https://github-contributions.vercel.app) | Create an image of your GitHub contributions | none | Yes | yes |
| [GitHub ReadMe Stats](https://github.com/anuraghazra/github-readme-stats) | Add dynamically generated statistics to your GitHub profile ReadMe | none | Yes | yes |
| [Metabase](https://www.metabase.com/) | An open source Business Intelligence server to share data and analytics inside your company | none | Yes | yes |
| [Shields](https://shields.io/) | Concise, consistent, and legible badges in SVG and raster format | none | Yes | unknown |
...
| [PatentsView](https://patentsview.org/apis/purpose) | API is intended to explore and visualize trends/patterns across the US innovation landscape | none | Yes | unknown |
...
| [USPTO](https://www.uspto.gov/learning-and-resources/open-data-and-mobility) | USA patent api services | none | Yes | unknown |
...
| API | Description | Auth | HTTPS | CORS |
| --- | --- | --- | --- | --- |
| [Advice Slip](http://api.adviceslip.com/) | Generate random advice slips | none | Yes | unknown |
| [Biriyani As A Service](https://biriyani.anoram.com/) | Biriyani images placeholder | none | Yes | no |
| [Dev.to](https://developers.forem.com/api) | Access Forem articles, users and other resources via API | `apiKey` | Yes | unknown |
| [Dictum](https://github.com/fisenkodv/dictum) | API to get access to the collection of the most inspiring expressions of mankind | none | Yes | unknown |
| [FavQs.com](https://favqs.com/api) | FavQs allows you to collect, discover and share your favorite quotes | `apiKey` | Yes | unknown |
| [FOAAS](http://www.foaas.com/) | Fuck Off As A Service | none | No | unknown |
| [Forismatic](http://forismatic.com/en/api/) | Inspirational Quotes | none | No | unknown |
| [icanhazdadjoke](https://icanhazdadjoke.com/api) | The largest selection of dad jokes on the internet | none | Yes | unknown |
| [Inspiration](https://inspiration.goprogram.ai/docs/) | Motivational and Inspirational quotes | none | Yes | yes |
| [kanye.rest](https://kanye.rest) | REST API for random Kanye West quotes | none | Yes | yes |
| [kimiquotes](https://kimiquotes.herokuapp.com/doc) | Team radio and interview quotes by Finnish F1 legend Kimi Räikkönen | none | Yes | yes |
...
| [Programming Quotes](https://github.com/skolakoda/programming-quotes-api) | Programming Quotes API for open source projects | none | Yes | unknown |
| [Quotable Quotes](https://github.com/lukePeavey/quotable) | Quotable is a free, open source quotations API | none | Yes | unknown |
| [Quote Garden](https://pprathameshmore.github.io/QuoteGarden/) | REST API for more than 5000 famous quotes | none | Yes | unknown |
| [quoteclear](https://quoteclear.web.app/) | Ever-growing list of James Clear quotes from the 3-2-1 Newsletter | none | Yes | yes |
| [Quotes on Design](https://quotesondesign.com/api/) | Inspirational Quotes | none | Yes | unknown |
| [Stoicism Quote](https://github.com/tlcheah2/stoic-quote-lambda-public-api) | Quotes about Stoicism | none | Yes | unknown |
| [They Said So Quotes](https://theysaidso.com/api/) | Quotes Trusted by many fortune brands around the world | none | Yes | unknown |
| [Traitify](https://app.traitify.com/developer) | Assess, collect and analyze Personality | none | Yes | unknown |
| [Udemy(instructor)](https://www.udemy.com/developers/instructor/) | API for instructors on Udemy | `apiKey` | Yes | unknown |
| [Vadivelu HTTP Codes](https://vadivelu.anoram.com/) | On demand HTTP Codes with images | none | Yes | no |
| [Zen Quotes](https://zenquotes.io/) | Large collection of Zen quotes for inspiration | none | Yes | yes |
...
| [Phone Specification](https://github.com/azharimm/phone-specs-api) | Rest Api for Phone specifications | none | Yes | yes |
...
| [apilayer screenshotlayer](https://screenshotlayer.com) | URL 2 Image | none | Yes | unknown |
...
| [Imsea](https://imsea.herokuapp.com/) | Free image search | none | Yes | unknown |
| [Lorem Picsum](https://picsum.photos/) | Images from Unsplash | none | Yes | unknown |
...
| [PlaceKeanu](https://placekeanu.com/) | Resizable Keanu Reeves placeholder images with grayscale and young Keanu options | none | Yes | unknown |
| [Readme typing SVG](https://github.com/DenverCoder1/readme-typing-svg) | Customizable typing and deleting text SVG | none | Yes | unknown |
| [Remove.bg](https://www.remove.bg/api) | Image Background removal | `apiKey` | Yes | unknown |
| [ReSmush.it](https://resmush.it/api) | Photo optimization | none | No | unknown |
...
| API | Description | Auth | HTTPS | CORS |
| --- | --- | --- | --- | --- |
| [arcsecond.io](https://api.arcsecond.io/) | Multiple astronomy data sources | none | Yes | unknown |
| [arXiv](https://arxiv.org/help/api/user-manual) | Curated research-sharing platform: physics, mathematics, quantitative finance, and economics | none | Yes | unknown |
| [CORE](https://core.ac.uk/services#api) | Access the world's Open Access research papers | `apiKey` | Yes | unknown |
| [GBIF](https://www.gbif.org/developer/summary) | Global Biodiversity Information Facility | none | Yes | yes |
| [iDigBio](https://github.com/idigbio/idigbio-search-api/wiki) | Access millions of museum specimens from organizations around the world | none | Yes | unknown |
| [inspirehep.net](https://github.com/inspirehep/rest-api-doc) | High Energy Physics info. system | none | Yes | unknown |
| [isEven (humor)](https://isevenapi.xyz/) | Check if a number is even | none | Yes | unknown |
| [ISRO](https://isro.vercel.app) | ISRO Space Crafts Information | none | Yes | no |
| [ITIS](https://www.itis.gov/ws_description.html) | Integrated Taxonomic Information System | none | Yes | unknown |
| [Launch Library 2](https://thespacedevs.com/llapi) | Spaceflight launches and events database | none | Yes | yes |
| [Materials Platform for Data Science](https://mpds.io) | Curated experimental data for materials science | `apiKey` | Yes | no |
| [Minor Planet Center](http://www.asterank.com/mpc) | Asterank.com Information | none | No | unknown |
| [NASA](https://api.nasa.gov) | NASA data, including imagery | none | Yes | no |
| [NASA ADS](https://ui.adsabs.harvard.edu/help/api/api-docs.html) | NASA Astrophysics Data System | `OAuth` | Yes | yes |
| [Newton](https://newton.vercel.app) | Symbolic and Arithmetic Math Calculator | none | Yes | no |
| [Noctua](https://api.noctuasky.com/api/v1/swaggerdoc/) | REST API used to access NoctuaSky features | none | Yes | unknown |
...
| [Ocean Facts](https://oceanfacts.herokuapp.com/) | Facts pertaining to the physical science of Oceanography | none | Yes | unknown |
| [Open Notify](http://open-notify.org/Open-Notify-API/) | ISS astronauts, current location, etc | none | No | no |
| [Open Science Framework](https://developer.osf.io) | Repository and archive for study designs, research materials, data, manuscripts, etc | none | Yes | unknown |
| [Purple Air](https://www2.purpleair.com/) | Real Time Air Quality Monitoring | none | Yes | unknown |
| [Remote Calc](https://github.com/elizabethadegbaju/remotecalc) | Decodes base64 encoding and parses it to return a solution to the calculation in JSON | none | Yes | yes |
| [SHARE](https://share.osf.io/api/v2/) | A free, open, dataset about research and scholarly activities | none | Yes | no |
| [SpaceX](https://github.com/r-spacex/SpaceX-API) | Company, vehicle, launchpad and launch data | none | Yes | no |
| [Sunrise and Sunset](https://sunrise-sunset.org/api) | Sunset and sunrise times for a given latitude and longitude | none | Yes | no |
| [Times Adder](https://github.com/FranP-code/API-Times-Adder) | With this API you can add each of the times introduced in the array sended | none | Yes | no |
| [TLE](https://tle.ivanstanojevic.me/#/docs) | Satellite information | none | Yes | no |
| [USGS Earthquake Hazards Program](https://earthquake.usgs.gov/fdsnws/event/1/) | Earthquakes data real-time | none | Yes | no |
| [USGS Water Services](https://waterservices.usgs.gov/) | Water quality and level info for rivers and lakes | none | Yes | no |
| [World Bank](https://datahelpdesk.worldbank.org/knowledgebase/topics/125589) | World Data | none | Yes | no |
| [xMath](https://x-math.herokuapp.com/) | Random mathematical expressions | none | Yes | yes |
...
| [Classify](https://classify-web.herokuapp.com/#/api) | Encrypting & decrypting text messages | none | Yes | yes |
...
| [Dehash.lt](https://github.com/Dehash-lt/api) | Hash decryption MD5, SHA1, SHA3, SHA256, SHA384, SHA512 | none | Yes | unknown |
| [EmailRep](https://docs.emailrep.io/) | Email address threat and risk prediction | none | Yes | unknown |
| [Escape](https://github.com/polarspetroll/EscapeAPI) | An API for escaping different kind of queries | none | Yes | no |
| [FilterLists](https://filterlists.com) | Lists of filters for adblockers and firewalls | none | Yes | unknown |
...
| [Hashable](https://hashable.space/pages/api/) | A REST API to access high level cryptographic functions and methods | none | Yes | yes |
...
| [Microsoft Security Response Center (MSRC)](https://msrc.microsoft.com/report/developer) | Programmatic interfaces to engage with the Microsoft Security Response Center (MSRC) | none | Yes | unknown |
| [Mozilla http scanner](https://github.com/mozilla/http-observatory/blob/master/httpobs/docs/api.md) | Mozilla observatory http scanner | none | Yes | unknown |
| [Mozilla tls scanner](https://github.com/mozilla/tls-observatory#api-endpoints) | Mozilla observatory tls scanner | none | Yes | unknown |
| [National Vulnerability Database](https://nvd.nist.gov/vuln/Data-Feeds/JSON-feed-changelog) | U.S. National Vulnerability Database | none | Yes | unknown |
| [Passwordinator](https://github.com/fawazsullia/password-generator/) | Generate random passwords of varying complexities | none | Yes | yes |
| [PhishStats](https://phishstats.info/) | Phishing database | none | Yes | unknown |
...
| [UK Police](https://data.police.uk/docs/) | UK Police data | none | Yes | unknown |
| [Virushee](https://api.virushee.com/) | Virushee file/data scanning | none | Yes | yes |
...
| API | Description | Auth | HTTPS | CORS |
| --- | --- | --- | --- | --- |
| [4chan](https://github.com/4chan/4chan-API) | Simple image-based bulletin board dedicated to a variety of topics | none | Yes | yes |
...
| [aztro](https://aztro.sameerkumar.website/) | Daily horoscope info for yesterday, today, and tomorrow | none | Yes | unknown |
...
| [Doge-Meme](https://api.doge-meme.lol/docs) | Top meme posts from r/dogecoin which include 'Meme' flair | none | Yes | yes |
| [Facebook](https://developers.facebook.com/) | Facebook Login, Share on FB, Social Plugins, Analytics and more | `OAuth` | Yes | unknown |
| [Foursquare](https://developer.foursquare.com/) | Interact with Foursquare users and places (geolocation-based checkins, photos, tips, events, etc) | `OAuth` | Yes | unknown |
| [Fuck Off as a Service](https://www.foaas.com) | Asks someone to fuck off | none | Yes | unknown |
| [Full Contact](https://docs.fullcontact.com/) | Get Social Media profiles and contact Information | `OAuth` | Yes | unknown |
| [HackerNews](https://github.com/HackerNews/API) | Social news for CS and entrepreneurship | none | Yes | unknown |
| [Hashnode](https://hashnode.com) | A blogging platform built for developers | none | Yes | unknown |
...
| [Lanyard](https://github.com/Phineas/lanyard) | Retrieve your presence on Discord through an HTTP REST API or WebSocket | none | Yes | yes |
...
| [Open Collective](https://docs.opencollective.com/help/developers/api) | Get Open Collective data | none | Yes | unknown |
...
| [balldontlie](https://www.balldontlie.io) | Balldontlie provides access to stats data from the NBA | none | Yes | yes |
...
| [City Bikes](https://api.citybik.es/v2/) | City Bikes around the world | none | Yes | unknown |
...
| [Ergast F1](http://ergast.com/mrd/) | F1 data from the beginning of the world championships in 1950 | none | Yes | unknown |
...
| [Football (Soccer) Videos](https://www.scorebat.com/video-api/) | Embed codes for goals and highlights from Premier League, Bundesliga, Serie A and many more | none | Yes | yes |
| [Football Standings](https://github.com/azharimm/football-standings-api) | Display football standings e.g epl, la liga, serie a etc. The data is based on espn site | none | Yes | yes |
...
| [MLB Records and Stats](https://appac.github.io/mlb-data-api-docs/) | Current and historical MLB statistics | none | No | unknown |
...
| [NBA Stats](https://any-api.com/nba_com/nba_com/docs/API_Description) | Current and historical NBA Statistics | none | Yes | unknown |
| [NHL Records and Stats](https://gitlab.com/dword4/nhlapi) | NHL historical data and statistics | none | Yes | unknown |
| [Oddsmagnet](https://data.oddsmagnet.com) | Odds history from multiple UK bookmakers | none | Yes | yes |
| [OpenLigaDB](https://www.openligadb.de) | Crowd sourced sports league results | none | Yes | yes |
...
| [Sport List & Data](https://developers.decathlon.com/products/sports) | List of and resources related to sports | none | Yes | yes |
| [Sport Places](https://developers.decathlon.com/products/sport-places) | Crowd-source sports places around the world | none | Yes | no |
...
| [Squiggle](https://api.squiggle.com.au) | Fixtures, results and predictions for Australian Football League matches | none | Yes | yes |
| [Strava](https://strava.github.io/api/) | Connect with athletes, activities and more | `OAuth` | Yes | unknown |
| [SuredBits](https://suredbits.com/api/) | Query sports data, including teams, players, games, scores and statistics | none | No | no |
...
| [ADS-B Exchange](https://www.adsbexchange.com/data/) | Access real-time and historical data of any and all airborne aircraft | none | Yes | unknown |
| [airportsapi](https://airport-web.appspot.com/api/docs/) | Get name and website-URL for airports by ICAO code | none | Yes | unknown |
...
| [AviationAPI](https://docs.aviationapi.com) | FAA Aeronautical Charts and Publications, Airport Information, and Airport Weather | none | Yes | no |
...
| [BC Ferries](https://www.bcferriesapi.ca) | Sailing times and capacities for BC Ferries | none | Yes | yes |
...
| [Community Transit](https://github.com/transitland/transitland-datastore/blob/master/README.md#api-endpoints) | Transitland API | none | Yes | unknown |
...
| [Icelandic APIs](http://docs.apis.is/) | Open APIs that deliver services in or regarding Iceland | none | Yes | unknown |
...
| [Metro Lisboa](http://app.metrolisboa.pt/status/getLinhas.php) | Delays in subway lines | none | No | no |
...
| [OpenSky Network](https://opensky-network.org/apidoc/index.html) | Free real-time ADS-B aviation data | none | Yes | unknown |
| [Railway Transport for France](https://www.digital.sncf.com/startup/api) | SNCF public API | `apiKey` | Yes | unknown |
| [REFUGE Restrooms](https://www.refugerestrooms.org/api/docs/#!/restrooms) | Provides safe restroom access for transgender, intersex and gender nonconforming individuals | none | Yes | unknown |
...
| [TransitLand](https://www.transit.land/documentation/datastore/api-endpoints.html) | Transit Aggregation | none | Yes | unknown |
| [Transport for Atlanta, US](http://www.itsmarta.com/app-developer-resources.aspx) | Marta | none | No | unknown |
| [Transport for Auckland, New Zealand](https://dev-portal.at.govt.nz/) | Auckland Transport | none | Yes | unknown |
| [Transport for Belgium](https://docs.irail.be/) | The iRail API is a third-party API for Belgian public transport by train | none | Yes | yes |
| [Transport for Berlin, Germany](https://github.com/derhuerst/vbb-rest/blob/3/docs/index.md) | Third-party VBB API | none | Yes | unknown |
...
| [Transport for Budapest, Hungary](https://bkkfutar.docs.apiary.io) | Budapest public transport API | none | Yes | unknown |
| [Transport for Chicago, US](http://www.transitchicago.com/developers/) | Chicago Transit Authority (CTA) | `apiKey` | No | unknown |
| [Transport for Czech Republic](https://www.chaps.cz/eng/products/idos-internet) | Czech transport API | none | Yes | unknown |
| [Transport for Denver, US](http://www.rtd-denver.com/gtfs-developer-guide.shtml) | RTD | none | No | unknown |
| [Transport for Finland](https://digitransit.fi/en/developers/) | Finnish transport API | none | Yes | unknown |
| [Transport for Germany](http://data.deutschebahn.com/dataset/api-fahrplan) | Deutsche Bahn (DB) API | `apiKey` | No | unknown |
| [Transport for Grenoble, France](https://www.mobilites-m.fr/pages/opendata/OpenDataApi.html) | Grenoble public transport | none | No | no |
| [Transport for Hessen, Germany](https://opendata.rmv.de/site/start.html) | RMV API (Public Transport in Hessen) | none | Yes | unknown |
...
| [Transport for Los Angeles, US](https://developer.metro.net/api/) | Data about positions of Metro vehicles in real time and travel their routes | none | Yes | unknown |
| [Transport for Manchester, England](https://developer.tfgm.com/) | TfGM transport network data | `apiKey` | Yes | no |
| [Transport for Norway](https://developer.entur.org/) | Transport APIs and dataset for Norway | none | Yes | unknown |
...
| [Transport for Paris, France](http://data.ratp.fr/api/v1/console/datasets/1.0/search/) | RATP Open Data API | none | No | unknown |
| [Transport for Philadelphia, US](http://www3.septa.org/hackathon/) | SEPTA APIs | none | No | unknown |
...
| [Transport for Spain](https://data.renfe.com/api/1/util/snippet/api_info.html?resource_id=a2368cff-1562-4dde-8466-9635ea3a572a) | Public trains of Spain | none | Yes | unknown |
...
| [Transport for Toronto, Canada](https://myttc.ca/developers) | TTC | none | Yes | unknown |
| [Transport for UK](https://developer.transportapi.com) | Transport API and dataset for UK | `apiKey` | Yes | unknown |
| [Transport for United States](https://retro.umoiq.com/xmlFeedDocs/NextBusXMLFeed.pdf) | NextBus API | none | No | unknown |
...
| [transport.rest](https://transport.rest) | Community maintained, developer-friendly public transport API | none | Yes | yes |
...
| [Velib metropolis, Paris, France](https://www.velib-metropole.fr/donnees-open-data-gbfs-du-service-velib-metropole) | Velib Open Data API | none | Yes | no |
...
| API | Description | Auth | HTTPS | CORS |
| --- | --- | --- | --- | --- |
| [Bacon Ipsum](https://baconipsum.com/json-api/) | A Meatier Lorem Ipsum Generator | none | Yes | unknown |
| [Dicebear Avatars](https://avatars.dicebear.com/) | Generate random pixel-art avatars | none | Yes | no |
| [English Random Words](https://random-words-api.vercel.app/word) | Generate English Random Words with Pronunciation | none | Yes | no |
| [FakeJSON](https://fakejson.com) | Service to generate test and fake data | `apiKey` | Yes | yes |
| [FakerAPI](https://fakerapi.it/en) | APIs collection to get fake data | none | Yes | yes |
| [FakeStoreAPI](https://fakestoreapi.com/) | Fake store rest API for your e-commerce or shopping website prototype | none | Yes | unknown |
| [GeneradorDNI](https://api.generadordni.es) | Data generator API. Profiles, vehicles, banks and cards, etc | `apiKey` | Yes | unknown |
| [ItsThisForThat](https://itsthisforthat.com/api.php) | Generate Random startup ideas | none | Yes | no |
| [JSONPlaceholder](http://jsonplaceholder.typicode.com/) | Fake data for testing and prototyping | none | No | unknown |
| [Loripsum](http://loripsum.net/) | The "lorem ipsum" generator that doesn't suck | none | No | unknown |
| [Mailsac](https://mailsac.com/docs/api) | Disposable Email | `apiKey` | Yes | unknown |
| [Metaphorsum](http://metaphorpsum.com/) | Generate demo paragraphs giving number of words and sentences | none | No | unknown |
| [Mockaroo](https://www.mockaroo.com/docs) | Generate fake data to JSON, CSV, TXT, SQL and XML | `apiKey` | Yes | unknown |
| [QuickMocker](https://quickmocker.com) | API mocking tool to generate contextual, fake or random data | none | Yes | yes |
| [Random Data](https://random-data-api.com) | Random data generator | none | Yes | unknown |
| [Randommer](https://randommer.io/randommer-api) | Random data generator | `apiKey` | Yes | yes |
| [RandomUser](https://randomuser.me) | Generates and list user data | none | Yes | unknown |
| [RoboHash](https://robohash.org/) | Generate random robot/alien avatars | none | Yes | unknown |
| [Spanish random names](https://random-names-api.herokuapp.com/public) | Generate spanish names (with gender) randomly | none | Yes | unknown |
| [Spanish random words](https://palabras-aleatorias-public-api.herokuapp.com) | Generate spanish words randomly | none | Yes | unknown |
| [This Person Does not Exist](https://thispersondoesnotexist.com) | Generates real-life faces of people who do not exist | none | Yes | unknown |
| [Toolcarton](https://testimonialapi.toolcarton.com/) | Generate random testimonial data | none | Yes | unknown |
| [UUID Generator](https://www.uuidtools.com/docs) | Generate UUIDs | none | Yes | no |
| [What The Commit](http://whatthecommit.com/index.txt) | Random commit message generator | none | No | yes |
| [Yes No](https://yesno.wtf/api) | Generate yes or no randomly | none | Yes | unknown |
...
| [LibreTranslate](https://libretranslate.com/docs) | Translation tool with 17 available languages | none | Yes | unknown |
...
| [PostalPinCode](http://www.postalpincode.in/Api-Details) | API for getting Pincode details in India | none | Yes | unknown |
| [Postmon](http://postmon.com.br) | An API to query Brazilian ZIP codes and orders easily, quickly and free | none | No | unknown |
...
| [WhatPulse](https://developer.whatpulse.org/#web-api) | Small application that measures your keyboard/mouse usage | none | Yes | unknown |
...
| API | Description | Auth | HTTPS | CORS |
| --- | --- | --- | --- | --- |
| [1pt](https://github.com/1pt-co/api/blob/main/README.md) | A simple URL shortener | none | Yes | yes |
| [Bitly](http://dev.bitly.com/get_started.html) | URL shortener and link management | `OAuth` | Yes | unknown |
| [CleanURI](https://cleanuri.com/docs) | URL shortener service | none | Yes | yes |
...
| [Drivet URL Shortener](https://wiki.drivet.xyz/en/url-shortener/add-links) | Shorten a long URL easily and fast | none | Yes | unknown |
| [Free Url Shortener](https://ulvis.net/developer.html) | Free URL Shortener offers a powerful API to interact with other sites | none | Yes | unknown |
| [Git.io](https://github.blog/2011-11-10-git-io-github-url-shortener/) | Git.io URL shortener | none | Yes | unknown |
| [GoTiny](https://github.com/robvanbakel/gotiny-api) | A lightweight URL shortener, focused on ease-of-use for the developer and end-user | none | Yes | yes |
| [Kutt](https://docs.kutt.it/) | Free Modern URL Shortener | `apiKey` | Yes | yes |
| [Mgnet.me](http://mgnet.me/api.html) | Torrent URL shorten API | none | Yes | no |
| [owo](https://owo.vc/api) | A simple link obfuscator/shortener | none | Yes | unknown |
| [Rebrandly](https://developers.rebrandly.com/v1/docs) | Custom URL shortener for sharing branded links | `apiKey` | Yes | unknown |
| [Short Link](https://github.com/FayasNoushad/Short-Link-API) | Short URLs support so many domains | none | Yes | unknown |
| [Shrtcode](https://shrtco.de/docs) | URl Shortener with multiple Domains | none | Yes | yes |
...
| API | Description | Auth | HTTPS | CORS |
| --- | --- | --- | --- | --- |
| [An API of Ice And Fire](https://anapioficeandfire.com/) | Game Of Thrones API | none | Yes | unknown |
| [Bob's Burgers](https://bobs-burgers-api-ui.herokuapp.com) | Bob's Burgers API | none | Yes | yes |
| [Breaking Bad](https://breakingbadapi.com/documentation) | Breaking Bad API | none | Yes | unknown |
| [Breaking Bad Quotes](https://github.com/shevabam/breaking-bad-quotes) | Some Breaking Bad quotes | none | Yes | unknown |
| [Catalogopolis](https://api.catalogopolis.xyz/docs/) | Doctor Who API | none | Yes | unknown |
| [Catch The Show](https://catchtheshow.herokuapp.com/api/documentation) | REST API for next-episode.net | none | Yes | unknown |
| [Czech Television](http://www.ceskatelevize.cz/xml/tv-program/) | TV programme of Czech TV | none | No | unknown |
| [Dailymotion](https://developer.dailymotion.com/) | Dailymotion Developer API | `OAuth` | Yes | unknown |
| [Dune](https://github.com/ywalia01/dune-api) | A simple API which provides you with book, character, movie and quotes JSON data | none | Yes | yes |
| [Final Space](https://finalspaceapi.com/docs/) | Final Space API | none | Yes | yes |
| [Game of Thrones Quotes](https://gameofthronesquotes.xyz/) | Some Game of Thrones quotes | none | Yes | unknown |
| [Harry Potter Charactes](https://hp-api.herokuapp.com/) | Harry Potter Characters Data with with imagery | none | Yes | unknown |
| [IMDb-API](https://imdb-api.com/) | API for receiving movie, serial and cast information | `apiKey` | Yes | unknown |
| [IMDbOT](https://github.com/SpEcHiDe/IMDbOT) | Unofficial IMDb Movie / Series Information | none | Yes | yes |
...
| [Lucifer Quotes](https://github.com/shadowoff09/lucifer-quotes) | Returns Lucifer quotes | none | Yes | unknown |
| [MCU Countdown](https://github.com/DiljotSG/MCU-Countdown) | A Countdown to the next MCU Film | none | Yes | yes |
| [Motivational Quotes](https://nodejs-quoteapp.herokuapp.com/) | Random Motivational Quotes | none | Yes | unknown |
| [Movie Quote](https://github.com/F4R4N/movie-quote/) | Random Movie and Series Quotes | none | Yes | yes |
| [Open Movie Database](http://www.omdbapi.com/) | Movie information | `apiKey` | Yes | unknown |
| [Owen Wilson Wow](https://owen-wilson-wow-api.herokuapp.com) | API for actor Owen Wilson's "wow" exclamations in movies | none | Yes | yes |
| [Ron Swanson Quotes](https://github.com/jamesseanwright/ron-swanson-quotes#ron-swanson-quotes-api) | Television | none | Yes | unknown |
| [Simkl](https://simkl.docs.apiary.io) | Movie, TV and Anime data | `apiKey` | Yes | unknown |
| [STAPI](http://stapi.co) | Information on all things Star Trek | none | No | no |
| [Stranger Things Quotes](https://github.com/shadowoff09/strangerthings-quotes) | Returns Stranger Things quotes | none | Yes | unknown |
| [Stream](https://api.stream.cz/graphiql) | Czech internet television, films, series and online videos for free | none | Yes | no |
| [Stromberg Quotes](https://www.stromberg-api.de/) | Returns Stromberg quotes and more | none | Yes | unknown |
| [SWAPI](https://swapi.dev/) | All the Star Wars data you've ever wanted | none | Yes | yes |
| [SWAPI GraphQL](https://graphql.org/swapi-graphql) | Star Wars GraphQL API | none | Yes | unknown |
...
| [ThronesApi](https://thronesapi.com/) | Game Of Thrones Characters Data with imagery | none | Yes | unknown |
...
| [TVMaze](http://www.tvmaze.com/api) | TV Show Data | none | No | unknown |
...
| [Web Series Quotes Generator](https://github.com/yogeshwaran01/web-series-quotes) | API generates various Web Series Quote Images | none | Yes | yes |
...
| [7Timer!](http://www.7timer.info/doc.php?lang=en) | Weather, especially for Astroweather | none | No | unknown |
...
| [AviationWeather](https://www.aviationweather.gov/dataserver) | NOAA aviation weather forecasts and observations | none | Yes | unknown |
...
| [Hong Kong Obervatory](https://www.hko.gov.hk/en/abouthko/opendata_intro.htm) | Provide weather information, earthquake information, and climate data | none | Yes | unknown |
| [MetaWeather](https://www.metaweather.com/api/) | Weather | none | Yes | no |
...
| [ODWeather](http://api.oceandrivers.com/static/docs.html) | Weather and weather webcams | none | No | unknown |
...
| [Open-Meteo](https://open-meteo.com/) | Global weather forecast API for non-commercial use | none | Yes | yes |
| [openSenseMap](https://api.opensensemap.org/) | Data from Personal Weather Stations called senseBoxes | none | Yes | yes |
...
| [RainViewer](https://www.rainviewer.com/api.html) | Radar data collected from different websites across the Internet | none | Yes | unknown |
| [Storm Glass](https://stormglass.io/) | Global marine weather from multiple sources | `apiKey` | Yes | yes |
| [Tomorrow](https://docs.tomorrow.io) | Weather API Powered by Proprietary Technology | `apiKey` | Yes | unknown |
| [US Weather](https://www.weather.gov/documentation/services-web-api) | US National Weather Service | none | Yes | yes |
| [Visual Crossing](https://www.visualcrossing.com/weather-api) | Global historical and weather forecast data | `apiKey` | Yes | yes |
| [weather-api](https://github.com/robertoduessmann/weather-api) | A RESTful free API to check the weather | none | Yes | no |
